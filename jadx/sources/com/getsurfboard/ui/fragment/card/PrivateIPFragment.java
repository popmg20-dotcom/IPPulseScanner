...
public final class PrivateIPFragment extends ek {
    public nj1 f;
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View viewInflate = layoutInflater.inflate(R.layout.fragment_private_ip, viewGroup, false);
        int i = R.id.ip;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        nj1 nj1Var = this.f;
        nj1Var.getClass();
        nj1Var.c.setOnClickListener(new w3(6));
        cr2.b.e(getViewLifecycleOwner(), new x3(7, new f0(16, this)));
    }
}
