...
public final class xr4 {
    ...
    static {
        float[] fArr = yr2.c;
        float fR0 = (float) ((((double) yr2.r0()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = yr2.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fR0) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f9 = 1.0f / ((5.0f * fR0) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fR0) * 5.0d))) + (f10 * fR0);
        float fR02 = yr2.r0() / fArr[1];
        double d2 = fR02;
        ...
        k = new xr4(fR02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public xr4(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
