...
public final class vl extends ek0 {
    public final yh4 t;

    public vl(yh4 yh4Var) {
        yh4Var.getClass();
        this.t = yh4Var;
    }

    public static boolean M(X509Certificate x509Certificate, X509Certificate x509Certificate2, int i) {
        if (!n12.c(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN()) || x509Certificate2.getBasicConstraints() < i) {
            return false;
        }
        try {
    ...
    public final List d(String str, List list) throws SSLPeerUnverifiedException {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (M(x509CertificateA, x509CertificateA, arrayList.size() - 2)) {
                return arrayList;
            }
            z = true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof vl) && n12.c(((vl) obj).t, this.t);
    }
