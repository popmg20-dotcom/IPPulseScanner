...
public final class a44 implements mn4, hy1, md4 {
    public static final pg f = new pg("camerax.core.streamSharing.captureTypes", List.class, null);
    public final sw2 b;

    public a44(sw2 sw2Var) {
        this.b = sw2Var;
    }
