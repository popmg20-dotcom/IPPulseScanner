...
public final /* synthetic */ class fa1 implements am1 {
    public final /* synthetic */ int b;
    public final /* synthetic */ ma1 f;

    public /* synthetic */ fa1(ma1 ma1Var, int i) {
        this.b = i;
        this.f = ma1Var;
    }
    ...
    public final Object g(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                cm2Var2.getClass();
                ((LinearLayoutCompat) cm2Var2.z).setVisibility(list.isEmpty() ? 0 : 8);
                ma1Var.z.s(list, new ga1(0, ma1Var));
                break;
            default:
                if (!((Boolean) obj).booleanValue() && ma1Var.X) {
                    ma1Var.X = false;
                        ...
                        try {
                            ...
                            if (yw1.G0) {
                                try {
                                    ...
                                    cm2Var3.getClass();
                                    CoordinatorLayout coordinatorLayout = (CoordinatorLayout) cm2Var3.f;
                                    ...
                                    cm2Var4.getClass();
                                    CoordinatorLayout coordinatorLayout2 = (CoordinatorLayout) cm2Var4.f;
                                ...
                                try {
                                    ...
                                    cm2 cm2Var32 = ma1Var.b;
                                    cm2Var32.getClass();
                                    CoordinatorLayout coordinatorLayout3 = (CoordinatorLayout) cm2Var32.f;
                                    coordinatorLayout3.getClass();
                                    r25.R(coordinatorLayout3, R.string.vpn_restarted, new Object[0]);
                                } catch (Exception e3) {
                                    tk3Var = new tk3(e3);
                                    cm2 cm2Var42 = ma1Var.b;
                                    cm2Var42.getClass();
                                    CoordinatorLayout coordinatorLayout22 = (CoordinatorLayout) cm2Var42.f;
