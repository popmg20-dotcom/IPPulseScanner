...
public final class gv1 implements q94 {
    public static final Parcelable.Creator<gv1> CREATOR = new o3(24);
    ...
    public gv1(String str, String str2, int i, String str3, String str4, boolean z, String str5, String str6, boolean z2, tn tnVar, String str7) {
        str.getClass();
        str2.getClass();
        tnVar.getClass();
        this.b = str;
    ...
    public final boolean equals(Object obj) {
        ...
        gv1 gv1Var = (gv1) obj;
        return n12.c(this.b, gv1Var.b) && n12.c(this.f, gv1Var.f) && this.z == gv1Var.z && n12.c(this.A, gv1Var.A) && n12.c(this.X, gv1Var.X) && this.Y == gv1Var.Y && n12.c(this.Z, gv1Var.Z) && n12.c(this.y0, gv1Var.y0) && this.z0 == gv1Var.z0 && this.A0 == gv1Var.A0 && n12.c(this.B0, gv1Var.B0);
    }
    ...
    public final String toString() {
        StringBuilder sbE = fw.E("Https(name=", this.b, ", host=", this.f, ", port=");
        sbE.append(this.z);
        sbE.append(", username=");
        sbE.append(this.A);
        sbE.append(", password=");
    ...
    public /* synthetic */ gv1(String str, String str2, int i, String str3, String str4, boolean z, String str5, String str6, tn tnVar, String str7) {
