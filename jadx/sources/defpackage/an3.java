...
public final class an3 implements bn3 {
    public static final Parcelable.Creator<an3> CREATOR = new ym3(1);
    public final ArrayList b;
    public final String f;

    public an3(String str, ArrayList arrayList) {
        str.getClass();
        this.b = arrayList;
        this.f = str;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        an3 an3Var = (an3) obj;
        return this.b.equals(an3Var.b) && n12.c(this.f, an3Var.f);
    }
    ...
    public final String toString() {
        return "Or(rules=" + this.b + ", proxy=" + this.f + ")";
    }
