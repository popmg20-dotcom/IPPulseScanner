...
public final class vj4 extends sj4 implements Serializable {
    public final ConcurrentHashMap A;
    public final HashMap X;
    public final bt3 z;

    public vj4(bt3 bt3Var, nj4 nj4Var, ConcurrentHashMap concurrentHashMap, HashMap map) {
    ...
    public final String toString() {
        return String.format("[%s; id-to-type=%s]", vj4.class.getName(), this.X);
    }
}
