...
public final class yx1 implements mn4, hy1, c22 {
    ...
    static {
        ...
        f = new pg("camerax.core.imageCapture.captureMode", cls, null);
        z = new pg("camerax.core.imageCapture.flashMode", cls, null);
        A = new pg("camerax.core.imageCapture.bufferFormat", Integer.class, null);
        X = new pg("camerax.core.imageCapture.outputFormat", Integer.class, null);
        Y = new pg("camerax.core.imageCapture.imageReaderProxyProvider", py1.class, null);
        Z = new pg("camerax.core.imageCapture.useSoftwareJpegEncoder", Boolean.TYPE, null);
        y0 = new pg("camerax.core.imageCapture.flashType", cls, null);
        z0 = new pg("camerax.core.imageCapture.screenFlash", vx1.class, null);
        A0 = new pg("camerax.core.useCase.isPostviewEnabled", Boolean.class, null);
    }

    public yx1(sw2 sw2Var) {
        this.b = sw2Var;
    }
    ...
    public final Size L() {
        int i = gy1.a;
        return (Size) p(hy1.B, null);
    }

    @Override // defpackage.mn4
    public final /* synthetic */ on4 M() {
        return qe4.a(this);
    }
    ...
    public final int T() {
        int i = gy1.a;
        return ((Integer) u(hy1.v)).intValue();
    }
    ...
    @Override // defpackage.hy1
    public final /* synthetic */ int f0(int i) {
        return gy1.d(this, i);
    }
    ...
    @Override // defpackage.dy1
    public final int n() {
        return ((Integer) dw2.m(this, dy1.s)).intValue();
    }
