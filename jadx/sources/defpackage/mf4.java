...
public final class mf4 implements rk0 {
    ...
    public mf4(Toolbar toolbar, boolean z) {
        Drawable drawable;
        this.n = 0;
        this.a = toolbar;
        ...
        n02 n02VarY = n02.y(toolbar.getContext(), null, cd3.a, R.attr.actionBarStyle);
        ...
        if (z) {
            ...
            if (!TextUtils.isEmpty(text)) {
                ...
                if ((this.b & 8) != 0) {
                    ...
                    if (this.g) {
                        wp4.o(toolbar.getRootView(), text);
                    }
                }
            }
            ...
            Drawable drawableO = n02VarY.o(20);
            if (drawableO != null) {
                this.e = drawableO;
                c();
            }
            Drawable drawableO2 = n02VarY.o(17);
            if (drawableO2 != null) {
                this.d = drawableO2;
                c();
            }
            ...
            if (resourceId3 != 0) {
                ...
                toolbar.G0 = resourceId3;
                AppCompatTextView appCompatTextView2 = toolbar.z;
        ...
        toolbar.setNavigationOnClickListener(new bb3(this));
    }
