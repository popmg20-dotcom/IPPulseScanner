...
public final class ai1 {
    ...
    public ai1(String str, String str2, String str3, List list, String str4, String str5) {
        str.getClass();
        this.a = str;
        str2.getClass();
        this.b = str2;
        ...
        this.e = str4;
        this.f = str5;
        StringBuilder sbE = fw.E(str, "-", str2, "-", str3);
        sbE.append("-");
        sbE.append(str4);
        sbE.append("-");
        sbE.append(str5);
    ...
    public final String toString() {
        ...
        StringBuilder sb2 = new StringBuilder(fw.y(sb, this.f, ", mCertificates:"));
        int i = 0;
        while (true) {
            List list = this.d;
            if (i >= list.size()) {
