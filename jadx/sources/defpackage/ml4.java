...
public enum ml4 {
    ...
    public static final ml4[] Dh = values();
    public final String b;
    public final byte[] f;
    public int[] z;

    ml4(String str, String str2) {
        this.b = str2;
        this.f = str.getBytes();
    }
        ...
        try {
            try {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    iArr2[i2] = dataInputStreamQ.readInt();
                }
                je.p(dataInputStreamQ, str);
                try {
                ...
                throw new r41("problem reading table: " + str + ": " + e);
            }
        } catch (Throwable th) {
            try {
                dataInputStreamQ.close();
