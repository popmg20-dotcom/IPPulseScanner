...
public final class OpenSSLSignatureRawRSA extends SignatureSpi {
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        ...
        if (privateKey instanceof OpenSSLRSAPrivateKey) {
            ...
            zo2.u("Need RSA private key");
            return;
        } else {
            openSSLRSAPrivateKey = OpenSSLRSAPrivateKey.getInstance((RSAPrivateKey) privateKey);
            this.key = openSSLRSAPrivateKey;
        }
        this.inputBuffer = new byte[NativeCrypto.RSA_size(openSSLRSAPrivateKey.getNativeRef())];
        this.inputOffset = 0;
    }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof OpenSSLRSAPublicKey) {
            ...
            zo2.u("Need RSA public key");
            return;
        } else {
            openSSLRSAPublicKey = OpenSSLRSAPublicKey.getInstance((RSAPublicKey) publicKey);
            this.key = openSSLRSAPublicKey;
        }
        this.inputBuffer = new byte[NativeCrypto.RSA_size(openSSLRSAPublicKey.getNativeRef())];
        this.inputOffset = 0;
    }
    ...
    public byte[] engineSign() throws SignatureException {
        ...
        if (this.inputIsTooLong) {
            ...
            sb.append(" != ");
            throw new SignatureException(fw.w(" (modulus size)", sb, this.inputBuffer.length));
        }
