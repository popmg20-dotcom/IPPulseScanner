...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public static abstract class DirectRSA extends OpenSSLCipherRSA {
        ...
        public int doCryptoOperation(byte[] bArr, byte[] bArr2) throws IllegalBlockSizeException {
            boolean z = this.encrypting;
            boolean z2 = this.usingPrivateKey;
            if (z) {
                return z2 ? NativeCrypto.RSA_private_encrypt(bArr.length, bArr, bArr2, this.key.getNativeRef(), this.padding) : NativeCrypto.RSA_public_encrypt(bArr.length, bArr, bArr2, this.key.getNativeRef(), this.padding);
            }
            try {
                return z2 ? NativeCrypto.RSA_private_decrypt(bArr.length, bArr, bArr2, this.key.getNativeRef(), this.padding) : NativeCrypto.RSA_public_decrypt(bArr.length, bArr, bArr2, this.key.getNativeRef(), this.padding);
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalBlockSizeException {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(fw.w(" bytes", new StringBuilder("input must be under "), this.buffer.length));
        }
        ...
        if (i3 != bArrCopyOf.length) {
            if (this.padding == 3) {
                ...
                System.arraycopy(bArrCopyOf, 0, bArr2, bArrCopyOf.length - i3, i3);
                bArrCopyOf = bArr2;
            } else {
    ...
    public int engineGetKeySize(Key key) throws InvalidKeyException {
        ...
        if (key == null) {
            zo2.u("RSA private or public key is null");
            return 0;
        }
        zo2.u("Need RSA private or public key");
        return 0;
    }
    ...
    public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        ...
        this.buffer = new byte[NativeCrypto.RSA_size(openSSLRSAPublicKey.getNativeRef())];
        this.bufferOffset = 0;
    ...
    public int keySizeBytes() {
        ...
        xe.q("cipher is not initialized");
        return 0;
    }
    ...
    public static class OAEP extends OpenSSLCipherRSA {
        ...
        @Override // org.conscrypt.OpenSSLCipherRSA
        public void doCryptoInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            boolean z = this.encrypting;
            OpenSSLKey openSSLKey = this.key;
            this.pkeyCtx = new NativeRef.EVP_PKEY_CTX(z ? NativeCrypto.EVP_PKEY_encrypt_init(openSSLKey.getNativeRef()) : NativeCrypto.EVP_PKEY_decrypt_init(openSSLKey.getNativeRef()));
        ...
        public int doCryptoOperation(byte[] bArr, byte[] bArr2) {
            ...
            return z ? NativeCrypto.EVP_PKEY_encrypt(evp_pkey_ctx, bArr2, 0, bArr, 0, bArr.length) : NativeCrypto.EVP_PKEY_decrypt(evp_pkey_ctx, bArr2, 0, bArr, 0, bArr.length);
        }
        ...
        public AlgorithmParameters engineGetParameters() {
            ...
            try {
                ...
                zo2.w("No providers of AlgorithmParameters.OAEP available");
                return null;
            }
        }
        ...
        public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
            if (i == 1 || i == 3) {
                if (!(key instanceof PublicKey)) {
                    zo2.u("Only public keys may be used to encrypt");
                    return;
                }
            } else if ((i == 2 || i == 4) && !(key instanceof PrivateKey)) {
                zo2.u("Only private keys may be used to decrypt");
                return;
            }
    ...
    @Override // javax.crypto.CipherSpi
    public int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalBlockSizeException, ShortBufferWithoutStackTraceException {
