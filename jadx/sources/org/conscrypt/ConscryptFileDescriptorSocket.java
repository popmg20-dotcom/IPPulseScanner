    ...
    */
    public org.conscrypt.ConscryptSession provideSession() {
        /*
            ...
            r2 = 8
            if (r1 != r2) goto L16
            org.conscrypt.SessionSnapshot r4 = r4.closedSession     // Catch: java.lang.Throwable -> L14
            if (r4 == 0) goto Le
            goto L12
        Le:
            org.conscrypt.ConscryptSession r4 = org.conscrypt.SSLNullSession.getNullSession()     // Catch: java.lang.Throwable -> L14
        L12:
        ...
        L2b:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L14
            if (r1 != 0) goto L33
            org.conscrypt.ConscryptSession r4 = org.conscrypt.SSLNullSession.getNullSession()
            return r4
        L33:
            org.conscrypt.ActiveSession r4 = r4.activeSession
            return r4
        L36:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L14
            throw r4
    ...
    public class SSLOutputStream extends OutputStream {
        ...
        public void write(int i) throws IOException {
            write(new byte[]{(byte) (i & DnsRecord.CLASS_ANY)});
        }
    }
    ...
    public class SSLInputStream extends InputStream {
        ...
        @Override // java.io.InputStream
        public int read(byte[] bArr, int i, int i2) throws SocketException {
            int i3;
            Platform.blockGuardOnNetwork();
            ConscryptFileDescriptorSocket.this.checkOpen();
            ArrayUtils.checkOffsetAndCount(bArr.length, i, i2);
