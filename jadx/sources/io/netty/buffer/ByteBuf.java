...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf>, ByteBufConvertible {
    ...
    public abstract int getBytes(int i, FileChannel fileChannel, long j, int i2);
    ...
    public abstract int readBytes(FileChannel fileChannel, long j, int i);
    ...
    public abstract int setBytes(int i, FileChannel fileChannel, long j, int i2);
    ...
    public abstract int writeBytes(FileChannel fileChannel, long j, int i);
