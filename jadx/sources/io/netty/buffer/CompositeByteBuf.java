    ...
    */
    private io.netty.buffer.CompositeByteBuf.Component newComponent(io.netty.buffer.ByteBuf r9, int r10) {
        /*
            ...
            r8 = r9
        L9:
            boolean r0 = r8 instanceof io.netty.buffer.WrappedByteBuf
            if (r0 != 0) goto L11
            boolean r0 = r8 instanceof io.netty.buffer.SwappedByteBuf
            if (r0 == 0) goto L13
        L11:
            r5 = r10
            goto L61
        L13:
            boolean r0 = r8 instanceof io.netty.buffer.AbstractUnpooledSlicedByteBuf
            if (r0 == 0) goto L26
            r0 = r8
            ...
            int r0 = r0.idx(r1)
            int r0 = r0 + r2
            io.netty.buffer.ByteBuf r8 = r8.unwrap()
        L24:
            r4 = r0
            goto L45
        L26:
            boolean r0 = r8 instanceof io.netty.buffer.PooledSlicedByteBuf
            if (r0 == 0) goto L35
            r0 = r8
            ...
            goto L24
        L35:
            boolean r0 = r8 instanceof io.netty.buffer.DuplicatedByteBuf
            if (r0 != 0) goto L40
            boolean r0 = r8 instanceof io.netty.buffer.PooledDuplicatedByteBuf
            if (r0 == 0) goto L3e
            goto L40
        L3e:
            r4 = r2
        ...
        L4f:
            ...
            io.netty.buffer.ByteBuf r3 = r8.order(r3)
            r5 = r10
    ...
    */
    public int setBytes(int r6, java.nio.channels.ScatteringByteChannel r7, int r8) {
        /*
            ...
            r5.checkIndex(r6, r8)
            if (r8 != 0) goto Lc
            java.nio.ByteBuffer r5 = io.netty.buffer.CompositeByteBuf.EMPTY_NIO_BUFFER
            int r5 = r7.read(r5)
            return r5
        Lc:
            int r0 = r5.toComponentIndex0(r6)
