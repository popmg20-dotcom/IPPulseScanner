...
class PooledHeapByteBuf extends PooledByteBuf<byte[]> {
    ...
    public final ByteBuf getBytes(int i, ByteBuf byteBuf, int i2, int i3) {
        ...
        if (byteBuf.hasMemoryAddress()) {
            PlatformDependent.copyMemory((byte[]) this.memory, idx(i), ((long) i2) + byteBuf.memoryAddress(), i3);
            return this;
        }
        if (byteBuf.hasArray()) {
    ...
    public final ByteBuf setBytes(int i, ByteBuf byteBuf, int i2, int i3) {
        ...
        if (byteBuf.hasMemoryAddress()) {
            PlatformDependent.copyMemory(byteBuf.memoryAddress() + ((long) i2), (byte[]) this.memory, idx(i), i3);
            return this;
        }
        if (byteBuf.hasArray()) {
    ...
    public final ByteBuf getBytes(int i, ByteBuffer byteBuffer) {
        ...
        byteBuffer.put((byte[]) this.memory, idx(i), iRemaining);
        return this;
    }
