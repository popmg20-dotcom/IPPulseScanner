...
public class HttpServerKeepAliveHandler extends ChannelDuplexHandler {
    ...
    public void write(ChannelHandlerContext channelHandlerContext, Object obj, ChannelPromise channelPromise) {
        ...
        ChannelPromise channelPromiseAddListener2 = channelPromise;
        if (obj instanceof LastHttpContent) {
            channelPromiseAddListener2 = channelPromise;
            if (!shouldKeepAlive()) {
                channelPromiseAddListener2 = channelPromise.unvoid().addListener2((GenericFutureListener<? extends Future<? super Void>>) ChannelFutureListener.CLOSE);
            }
        }
        super.write(channelHandlerContext, obj, channelPromiseAddListener2);
    }
}
