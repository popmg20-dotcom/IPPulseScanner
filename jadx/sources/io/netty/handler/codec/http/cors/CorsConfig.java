...
public final class CorsConfig {
    ...
    public Set<String> allowedRequestHeaders() {
        return DesugarCollections.unmodifiableSet(this.allowedRequestHeaders);
    }

    public Set<HttpMethod> allowedRequestMethods() {
        return DesugarCollections.unmodifiableSet(this.allowedRequestMethods);
    }

    public Set<String> exposedHeaders() {
        return DesugarCollections.unmodifiableSet(this.exposeHeaders);
    }
