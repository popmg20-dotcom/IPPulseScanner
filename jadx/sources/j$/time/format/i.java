    ...
    */
    ...
    public final int i(p pVar, CharSequence charSequence, int i) {
        ...
        if (length2 == 0) {
            ...
            charSequence2 = charSequence;
            if (pVar.g(charSequence2, i, str, 0, length2)) {
        ...
        if (cCharAt == '+' || cCharAt == '-') {
            ...
            if (i10 > 0) {
                ...
                if (i11 <= 23 && (i3 = iArr[2]) <= 59 && (i4 = iArr[3]) <= 59) {
                    return pVar.f(j$.time.temporal.a.OFFSET_SECONDS, ((((long) i3) * 60) + (((long) i11) * 3600) + ((long) i4)) * ((long) i7), i, i10);
                }
                j$.time.h.j("Value out of range: Hour[0-23], Minute[0-59], Second[0-59]");
                return 0;
            }
        } else {
            i2 = length2;
        }
        return i2 == 0 ? pVar.f(j$.time.temporal.a.OFFSET_SECONDS, 0L, i, i) : ~i;
    }
