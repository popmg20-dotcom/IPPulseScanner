...
public abstract class y6 implements Spliterator {
    ...
    public y6(a aVar, Supplier supplier, boolean z) {
        this.b = aVar;
        this.c = supplier;
        this.d = null;
        this.a = z;
    ...
    public abstract y6 e(Spliterator spliterator);
    ...
    public y6(a aVar, Spliterator spliterator, boolean z) {
        this.b = aVar;
        this.c = null;
        this.d = spliterator;
        this.a = z;
