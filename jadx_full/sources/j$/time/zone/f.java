    ...
    public final Object e(LocalDateTime localDateTime) {
        ...
        if (this.g != null) {
            ...
            if (bVarArrB.length == 0) {
                return g(this.g.getOffset(j$.time.a.v(localDateTime, this.b[0]) * 1000));
            }
        ...
        if (this.f.length > 0) {
            ...
            if (localDateTime2 != null) {
                ...
                z = localDateTime.A(localDateTime2) > 0;
            } else {
                long jT = localDateTime.a.t();
                long jT2 = localDateTime2.a.t();
                if (jT > jT2 || (jT == jT2 && localDateTime.b.M() > localDateTime2.b.M())) {
                }
            }
            if (z) {
