...
public final class c0 extends d {
    ...
    */
    public final c0 c(long j, j$.time.temporal.q qVar) {
        if (!(qVar instanceof j$.time.temporal.a)) {
            return (c0) super.c(j, qVar);
        }
        ...
        if (i == 4) {
            int iA = a0.c.G(aVar).a(j, aVar);
            int i2 = iArr[aVar.ordinal()];
            if (i2 == 4) {
                return H(this.a.V(F() >= 1 ? iA + 1911 : 1912 - iA));
            }
            if (i2 == 6) {
                return H(this.a.V(iA + 1911));
            }
            if (i2 == 7) {
                return H(this.a.V(1912 - F()));
            }
        } else {
            if (i == 5) {
                ...
                return H(iVar.P(j - ((jF + ((long) iVar.b)) - 1)));
            }
            if (i == 6 || i == 7) {
            }
        }
    ...
    public final c0 H(j$.time.i iVar) {
        return iVar.equals(this.a) ? this : new c0(iVar);
    }
    ...
    public final j$.time.temporal.u j(j$.time.temporal.q qVar) {
        ...
        return j$.time.temporal.u.f(1L, F() <= 0 ? (-uVar.a) + 1912 : uVar.d - 1911);
    }

    @Override // j$.time.chrono.d, j$.time.chrono.b
    public final b o(j$.time.temporal.n nVar) {
        return (c0) super.o(nVar);
    }

    @Override // j$.time.chrono.d, j$.time.temporal.m
    public final j$.time.temporal.m p(long j, j$.time.temporal.b bVar) {
        return (c0) super.p(j, bVar);
    }
