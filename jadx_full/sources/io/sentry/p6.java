...
public class p6 {
    ...
    */
    public p6(boolean z) {
        ...
        int i = 1;
        this.serializer = new io.sentry.util.f(new z5(this, i));
        this.envelopeReader = new io.sentry.util.f(new z5(this, 2));
        this.maxDepth = 100;
        ...
        this.envelopeDiskCache = io.sentry.transport.i.b;
        ...
        this.maxRequestBodySize = n6.NONE;
        this.traceSampling = true;
        this.maxTraceFileSize = 5242880L;
        this.transactionProfiler = q2.X;
        this.continuousProfiler = t2.b;
        ...
        this.distributionController = q2.f;
        ...
        this.openTelemetryMode = y5.AUTO;
        this.captureOpenTelemetryEvents = false;
        this.versionDetector = l3.b;
        ...
        h6 h6Var = new h6();
        h6Var.a = false;
        h6Var.b = new io.sentry.logger.e();
        this.logs = h6Var;
        i6 i6Var = new i6();
        i6Var.a = true;
        i6Var.b = new io.sentry.metrics.c();
        this.metrics = i6Var;
        this.socketTagger = g3.b;
        this.distribution = new g6();
        io.sentry.protocol.u uVar = new io.sentry.protocol.u("sentry.java", "8.51.0");
        uVar.f = "8.51.0";
        ...
        t6Var.t = list2;
        if (!z) {
            ((CopyOnWriteArraySet) t6Var.a).add("android.widget.TextView");
            ((CopyOnWriteArraySet) t6Var.a).add("android.widget.ImageView");
            ((CopyOnWriteArraySet) t6Var.a).add("android.webkit.WebView");
            ((CopyOnWriteArraySet) t6Var.a).add("android.widget.VideoView");
            ((CopyOnWriteArraySet) t6Var.a).add("androidx.camera.view.PreviewView");
            ((CopyOnWriteArraySet) t6Var.a).add("androidx.media3.ui.PlayerView");
            ((CopyOnWriteArraySet) t6Var.a).add("com.google.android.exoplayer2.ui.PlayerView");
            ((CopyOnWriteArraySet) t6Var.a).add("com.google.android.exoplayer2.ui.StyledPlayerView");
            t6Var.l = uVar;
        }
        ...
        if (io.sentry.util.j.a || !io.sentry.util.g.d("io.sentry.opentelemetry.OtelSpanFactory", w2Var) || (clsF = io.sentry.util.g.f(w2Var, "io.sentry.opentelemetry.OtelSpanFactory", true)) == null) {
            i3Var = new i3(i);
        } else {
            try {
                Object objNewInstance = clsF.getDeclaredConstructor(null).newInstance(null);
                if (objNewInstance instanceof o1) {
                    i3Var = (o1) objNewInstance;
                }
        ...
        uncaughtExceptionHandlerIntegration.A = false;
        ...
        this.eventProcessors.add(new p(this, 1));
        if (!io.sentry.util.j.a) {
            this.eventProcessors.add(new p());
        }
        setSentryClientName("sentry.java/8.51.0");
        setSdkVersion(uVar);
        n5.d().b("maven:io.sentry:sentry", "8.51.0");
    }
