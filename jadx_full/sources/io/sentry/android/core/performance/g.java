...
public final class g extends a {
    ...
    */
    public final void d() {
        ...
        this.D0.set(false);
        if (this.B0.get() == 0) {
            if (this.F0 == null || !p0.f()) {
                this.f.b(Boolean.FALSE);
                if (this.b == f.UNKNOWN) {
                    this.b = f.COLD;
                }
                o73 o73Var = this.F0;
                if (o73Var == null || !this.E0.compareAndSet(false, true)) {
                    return;
                }
                h hVar = this.Y;
                if (hVar.e()) {
                    ...
                    if (applicationStartInfo == null || Build.VERSION.SDK_INT < 35) {
                        ...
                        try {
                            ...
                            if (l != null) {
                                j(l.longValue() / 1000000);
                            }
                        } catch (Throwable unused) {
                        }
                    }
                }
                ActivityLifecycleIntegration activityLifecycleIntegration = (ActivityLifecycleIntegration) o73Var.f;
                if (activityLifecycleIntegration.z == null || activityLifecycleIntegration.A == null || !activityLifecycleIntegration.X) {
                    return;
                }
                g gVarC = c();
                gVarC.getClass();
                ...
                if (hVar2.d() && hVar2.e()) {
                    u5 u5VarB = hVar2.b();
                    if (hVar2.e()) {
                        u5Var = new u5((hVar2.d() ? hVar2.a() + hVar2.f : 0L) * 1000000);
                    } else {
                        u5Var = null;
                    }
                    if (u5VarB == null || u5Var == null) {
                        return;
                    }
                    gVarC.J0 = u5Var;
                    ...
                    if (gVarC.A0) {
                        ...
                        k7Var.e = false;
                        p1 p1VarM = activityLifecycleIntegration.z.m(new j7("App Start", i0.COMPONENT, "app.start", null), k7Var);
                        String strA = gVarC2.a();
                        if (strA != null) {
                            p1VarM.h(strA, "app.vitals.start.reason");
                        }
                        gVarC2.G0 = p1VarM.r().b;
                        gVarC2.H0 = p1VarM.b().a();
                        io.sentry.d dVarI = p1VarM.i();
                        gVarC2.I0 = dVarI != null ? dVarI.a : null;
                        p1VarM.t(f7.OK, u5Var);
                    }
                }
            }
        }
