...
final class ReplayingDecoderByteBuf extends ByteBuf {
    ...
    public int bytesBefore(int i, int i2, byte b) {
        ...
        int iBytesBefore = byteBuf.bytesBefore(i, iWriterIndex - i, b);
        if (iBytesBefore >= 0) {
            return iBytesBefore;
        }
        throw REPLAY;
    ...
    @Override // io.netty.buffer.ByteBuf
    public int capacity() {
        return this.terminated ? this.buffer.capacity() : ChannelUtils.WRITE_STATUS_SNDBUF_FULL;
    }
    ...
    public int forEachByte(int i, int i2, ByteProcessor byteProcessor) {
        ...
        ByteBuf byteBuf = this.buffer;
        if (i <= i3) {
            return byteBuf.forEachByte(i, i2, byteProcessor);
        }
        int iForEachByte = byteBuf.forEachByte(i, iWriterIndex - i, byteProcessor);
        if (iForEachByte >= 0) {
            return iForEachByte;
        }
        throw REPLAY;
    ...
    public int readableBytes() {
        ...
        ByteBuf byteBuf = this.buffer;
        return z ? byteBuf.readableBytes() : ChannelUtils.WRITE_STATUS_SNDBUF_FULL - byteBuf.readerIndex();
    }
