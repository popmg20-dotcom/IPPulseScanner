...
public class HttpPostMultipartRequestDecoder implements InterfaceHttpPostRequestDecoder {
    ...
    */
    private InterfaceHttpData decodeMultipart(HttpPostRequestDecoder.MultiPartStatus multiPartStatus) {
        ...
        long j;
        Attribute attributeCreateAttribute;
            ...
            case 5:
                ...
                if (this.currentAttribute == null) {
                    ...
                    if (attribute3 != null) {
                        ...
                        try {
                            if (j <= 0) {
                                attributeCreateAttribute = httpDataFactory.createAttribute(this.request, cleanString(attribute2.getValue()), j);
                                this.currentAttribute = attributeCreateAttribute;
                            } else {
                                attributeCreateAttribute = httpDataFactory.createAttribute(this.request, cleanString(attribute2.getValue()));
                                this.currentAttribute = attributeCreateAttribute;
                            }
                            if (charsetForName != null) {
                                attributeCreateAttribute.setCharset(charsetForName);
                            }
                        ...
                        j = 0;
                        HttpDataFactory httpDataFactory2 = this.factory;
                        if (j <= 0) {
                        }
                        if (charsetForName != null) {
                        }
