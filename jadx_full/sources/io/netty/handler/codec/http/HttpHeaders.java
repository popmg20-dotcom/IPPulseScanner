...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        if (z) {
            ...
            if (iIndexOf != -1) {
                int i = 0;
                while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i, iIndexOf)), charSequence2)) {
                    i = iIndexOf + 1;
                    iIndexOf = AsciiString.indexOf(charSequence, StringUtil.COMMA, i);
                    if (iIndexOf == -1) {
            ...
            if (iIndexOf2 != -1) {
                int i2 = 0;
                while (!AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i2, iIndexOf2)), charSequence2)) {
                    i2 = iIndexOf2 + 1;
                    iIndexOf2 = AsciiString.indexOf(charSequence, StringUtil.COMMA, i2);
                    if (iIndexOf2 == -1) {
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        while (itValueCharSequenceIterator.hasNext()) {
            if (containsCommaSeparatedTrimmed(itValueCharSequenceIterator.next(), charSequence2, z)) {
                return true;
            }
        }
        return false;
    ...
    @Deprecated
    public static Date getDateHeader(HttpMessage httpMessage, String str) {
