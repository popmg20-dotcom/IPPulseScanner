...
public final class Snappy {
    ...
    */
    public void encode(ByteBuf byteBuf, ByteBuf byteBuf2, int i) {
        ...
        if (i - i4 >= 15) {
            int i5 = i4 + 1;
            int iHash = hash(byteBuf, i5, iNumberOfLeadingZeros);
            int i6 = i4;
            loop1: while (true) {
                int i7 = 32;
                while (true) {
                    ...
                    int iHash2 = hash(byteBuf, i9, iNumberOfLeadingZeros);
                    int i11 = hashTable[iHash] + i4;
                    hashTable[iHash] = (short) (i5 - i4);
                ...
                iHash = hash(byteBuf, i6 + 1, iNumberOfLeadingZeros);
                i5 = i6 + 1;
            }
            i4 = i6;
        }
        if (i4 < i) {
            encodeLiteral(byteBuf, byteBuf2, i - i4);
        }
    }
