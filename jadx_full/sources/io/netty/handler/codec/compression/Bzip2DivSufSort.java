    ...
    */
    private void trIntroSort(int i, int i2, int i3, int i4, int i5, TRBudget tRBudget, int i6) {
        ...
        while (true) {
            if (iTrLog2 < 0) {
                if (iTrLog2 == -1) {
                    if (!tRBudget.update(i6, i27 - i26)) {
                        break;
                    }
                    int i29 = i25 - 1;
                    PartitionResult partitionResultTrPartition = bzip2DivSufSort.trPartition(i, i29, i3, i26, i27, i27 - 1);
                    int i30 = partitionResultTrPartition.first;
                    int i31 = partitionResultTrPartition.last;
                    if (i26 < i30 || i31 < i27) {
                        if (i30 < i27) {
                            int i32 = i30 - 1;
                            for (int i33 = i26; i33 < i30; i33++) {
                                iArr[i + iArr[i33]] = i32;
                            }
                        }
                        if (i31 < i27) {
                        ...
                        stackEntryArr2[i28] = new StackEntry(i24, i30, i31, i24);
                        int i36 = i28 + 2;
                        stackEntryArr2[i28 + 1] = new StackEntry(i29, i26, i27, -2);
                        int i37 = i30 - i26;
                        int i38 = i27 - i31;
                        if (i37 <= i38) {
                            if (1 < i37) {
                                i28 += 3;
                                stackEntryArr2[i36] = new StackEntry(i25, i31, i27, trLog(i38));
                                iTrLog = trLog(i37);
                                i27 = i30;
                                iTrLog2 = iTrLog;
                            } else if (1 < i38) {
                                ...
                                i28++;
                                StackEntry stackEntry = stackEntryArr2[i28];
                                i7 = stackEntry.a;
                                i8 = stackEntry.b;
                                i9 = stackEntry.c;
                                i10 = stackEntry.d;
                            ...
                            i28 += 3;
                            stackEntryArr2[i36] = new StackEntry(i25, i26, i30, trLog(i37));
                            iTrLog2 = trLog(i38);
                            i26 = i31;
                        } else if (1 < i37) {
                            iTrLog = trLog(i37);
                            ...
                            i28++;
                            StackEntry stackEntry2 = stackEntryArr2[i28];
                            i7 = stackEntry2.a;
                            i8 = stackEntry2.b;
                            i9 = stackEntry2.c;
                            i10 = stackEntry2.d;
                        ...
                        i28--;
                        StackEntry stackEntry3 = stackEntryArr2[i28];
                        i7 = stackEntry3.a;
                        i8 = stackEntry3.b;
                        i9 = stackEntry3.c;
                        i10 = stackEntry3.d;
                    ...
                    int i39 = i28 - 1;
                    StackEntry stackEntry4 = stackEntryArr2[i39];
                    trCopy(i, i3, i26, stackEntry4.b, stackEntry4.c, i27, i25 - i);
                    if (i39 == 0) {
                        return;
                    }
                    i28 -= 2;
                    StackEntry stackEntry5 = stackEntryArr2[i28];
                    i25 = stackEntry5.a;
                    i26 = stackEntry5.b;
                    i27 = stackEntry5.c;
                    ...
                    if (i26 < i27) {
                        ...
                        iTrLog2 = iArr[i + i12] != iArr[i12 + i25] ? trLog((i11 - i26) + 1) : -1;
                        int i41 = i40 + 2;
                        if (i41 < i27) {
                            int i42 = i40 + 1;
                            for (int i43 = i26; i43 < i41; i43++) {
                                iArr[i + iArr[i43]] = i42;
                            }
                        }
                        int i44 = i27 - i41;
                        if (i41 - i26 <= i44) {
                            stackEntryArr2[i28] = new StackEntry(i25, i41, i27, -3);
                            i25++;
                            i24 = 0;
                            i28++;
                            i27 = i41;
                        } else if (1 < i44) {
                            stackEntryArr2[i28] = new StackEntry(i25 + 1, i26, i41, iTrLog2);
                            i24 = 0;
                            i28++;
                            i26 = i41;
                            iTrLog2 = -3;
                        ...
                        i28--;
                        StackEntry stackEntry6 = stackEntryArr2[i28];
                        i25 = stackEntry6.a;
                        i26 = stackEntry6.b;
                        i27 = stackEntry6.c;
                ...
                if (i46 > 8) {
                    ...
                    if (iTrLog2 != 0) {
                        ...
                        bzip2DivSufSort = this;
                        i13 = i;
                        swapElements(iArr, i26, iArr, bzip2DivSufSort.trPivot(i13, i15, i3, i26, i27));
                        int iTrGetC5 = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i26]);
                        int i48 = iTrLog2;
                        int i49 = i26 + 1;
                        while (i49 < i27) {
                            iTrGetC4 = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i49]);
                        ...
                        if (i49 < i27 && iTrGetC4 < iTrGetC5) {
                            ...
                            while (true) {
                                ...
                                iTrGetC = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i49]);
                                if (iTrGetC > iTrGetC5) {
                                    break;
                                }
                                if (iTrGetC == iTrGetC5) {
                                    swapElements(iArr, i49, iArr, i16);
                                    i16++;
                                }
                                i50 = iTrGetC;
                                stackEntryArr2 = stackEntryArr;
                        ...
                        while (true) {
                            ...
                            iTrGetC2 = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i52]);
                        ...
                        if (i49 >= i52 || iTrGetC2 <= iTrGetC5) {
                            ...
                            i21 = i52;
                            while (i19 < i52) {
                                swapElements(iArr, i19, iArr, i52);
                                while (true) {
                                    i19++;
                                    int i53 = i52;
                                    if (i19 >= i52) {
                                    ...
                                    int iTrGetC6 = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i19]);
                                    if (iTrGetC6 > iTrGetC5) {
                                        i20 = iTrGetC6;
                                        i52 = i53;
                                        break;
                                    } else {
                                ...
                                while (true) {
                                    ...
                                    iTrGetC3 = bzip2DivSufSort.trGetC(i13, i15, i3, iArr[i52]);
                                    if (iTrGetC3 < iTrGetC5) {
                                        break;
                                    }
                                    if (iTrGetC3 == iTrGetC5) {
                                        swapElements(iArr, i52, iArr, i21);
                                        i21--;
                                    }
                                    i20 = iTrGetC3;
                                    i19 = i23;
                            ...
                            if (i18 > i21) {
                                ...
                                int i59 = i26;
                                while (i58 > 0) {
                                    swapElements(iArr, i59, iArr, i57);
                                    i58--;
                                    i59++;
                                    i57++;
                                }
                                ...
                                int i62 = i27 - i61;
                                while (i61 > 0) {
                                    swapElements(iArr, i19, iArr, i62);
                                    i61--;
                                    i19++;
                                    i62++;
                                }
                                int i63 = i26 + i56;
                                int i64 = i27 - i60;
                                int iTrLog3 = iArr[iArr[i63] + i13] != iTrGetC5 ? trLog(i64 - i63) : -1;
                                int i65 = i63 - 1;
                                for (int i66 = i26; i66 < i63; i66++) {
                                    iArr[iArr[i66] + i13] = i65;
                                }
                                if (i64 < i27) {
                                    int i67 = i64 - 1;
                                    for (int i68 = i63; i68 < i64; i68++) {
                                        iArr[iArr[i68] + i13] = i67;
                                    }
                                }
                                int i69 = i63 - i26;
                                int i70 = i27 - i64;
                                if (i69 <= i70) {
                                    ...
                                    if (i70 <= i71) {
                                        if (1 < i69) {
                                            stackEntryArr[i14] = new StackEntry(i15 + 1, i63, i64, iTrLog3);
                                            i22 = i14 + 2;
                                            stackEntryArr[i14 + 1] = new StackEntry(i15, i64, i27, i47);
                                            i27 = i63;
                                            i28 = i22;
                                            iTrLog2 = i47;
                                            stackEntryArr2 = stackEntryArr;
                                            ...
                                            i28 = i14 - 1;
                                            StackEntry stackEntry7 = stackEntryArr[i28];
                                            i25 = stackEntry7.a;
                                            i26 = stackEntry7.b;
                                            i27 = stackEntry7.c;
                                        ...
                                        if (1 < i69) {
                                            stackEntryArr[i14] = new StackEntry(i15, i64, i27, i47);
                                            stackEntryArr[i14 + 1] = new StackEntry(i15 + 1, i63, i64, iTrLog3);
                                            i25 = i15;
                                            i28 = i14 + 2;
                                            i27 = i63;
                                            iTrLog2 = i47;
                                        ...
                                        stackEntryArr[i14] = new StackEntry(i15, i64, i27, i47);
                                        stackEntryArr[i14 + 1] = new StackEntry(i15, i26, i63, i47);
                                        i28 = i14 + 2;
                                        i26 = i63;
                                        iTrLog2 = iTrLog3;
                                        stackEntryArr2 = stackEntryArr;
                                    ...
                                    if (i69 <= i72) {
                                        if (1 < i70) {
                                            ...
                                            i28 = i14 + 1;
                                            stackEntryArr[i14] = new StackEntry(i15, i26, i27, i47);
                                            i25 = i15;
                                            iTrLog2 = i47;
                                        }
                                    } else if (i70 <= i72) {
                                        if (1 < i70) {
                                            stackEntryArr[i14] = new StackEntry(i15, i26, i63, i47);
                                            stackEntryArr[i14 + 1] = new StackEntry(i15 + 1, i63, i64, iTrLog3);
                                            i25 = i15;
                                            i28 = i14 + 2;
                                            iTrLog2 = i47;
                        ...
                        bzip2DivSufSort = this;
                        bzip2DivSufSort.trHeapSort(i, i15, i3, i26, i46);
                        int i74 = i45 - 1;
                        while (i26 < i74) {
                            iTrGetC4 = bzip2DivSufSort.trGetC(i, i15, i3, iArr[i74]);
                            i74--;
                            while (i26 <= i74 && bzip2DivSufSort.trGetC(i, i15, i3, iArr[i74]) == iTrGetC4) {
                                iArr[i74] = ~iArr[i74];
                                i74--;
                            }
                        }
                    ...
                    i15 = i25;
                    bzip2DivSufSort = this;
                    bzip2DivSufSort.trInsertionSort(i, i15, i3, i26, i27);
                    i24 = 0;
                    iTrLog2 = -3;
                    i25 = i15;
                }
        ...
        for (int i76 = 0; i76 < i75; i76++) {
            StackEntry stackEntry8 = stackEntryArr[i76];
            if (stackEntry8.d == -3) {
                bzip2DivSufSort.lsUpdateGroup(i13, stackEntry8.b, stackEntry8.c);
            }
        }
    }
