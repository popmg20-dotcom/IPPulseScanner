    ...
    public static class BaseBehavior<T extends AppBarLayout> extends jr1 {
        ...
        */
        public static void G(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, int i2, boolean z) {
            ...
            if (childAt != null) {
                int i4 = ((z9) childAt.getLayoutParams()).a;
                if ((i4 & 1) != 0) {
            ...
            if (appBarLayout.E0) {
                zF = appBarLayout.f(C(coordinatorLayout));
            }
            boolean zE = appBarLayout.e(zF);
            if (!z) {
                if (zE) {
                    List list = (List) ((xw3) coordinatorLayout.f.z).get(appBarLayout);
                    ...
                    for (int i5 = 0; i5 < size; i5++) {
                        qe0 qe0Var = ((te0) ((View) arrayList.get(i5)).getLayoutParams()).a;
                        if (qe0Var instanceof ScrollingViewBehavior) {
                            if (((ScrollingViewBehavior) qe0Var).Y == 0) {
                                return;
                            }
                        }
                    }
                ...
                if (iY != iM) {
                    if (appBarLayout.y0) {
                        ...
                        while (true) {
                            ...
                            z9 z9Var = (z9) childAt.getLayoutParams();
                            Interpolator interpolator = z9Var.c;
                            if (iAbs < childAt.getTop() || iAbs > childAt.getBottom()) {
                                i5++;
                            } else if (interpolator != null) {
                                int i6 = z9Var.a;
                                if ((i6 & 1) != 0) {
                                    topInset = childAt.getHeight() + ((LinearLayout.LayoutParams) z9Var).topMargin + ((LinearLayout.LayoutParams) z9Var).bottomMargin;
                                    if ((i6 & 2) != 0) {
                        ...
                        if (r02Var == null) {
                            ...
                            if (z) {
                                ...
                                while (i9 < appBarLayout.getChildCount()) {
                                    z9 z9Var2 = (z9) appBarLayout.getChildAt(i9).getLayoutParams();
                                    lb lbVar = z9Var2.b;
                                    if (lbVar != null && (z9Var2.a & i7) != 0) {
                                        View childAt2 = appBarLayout.getChildAt(i9);
                                        float fW = w();
                                        Rect rect = (Rect) lbVar.z;
                                        Rect rect2 = (Rect) lbVar.f;
                                        ...
                                        if (fAbs <= 0.0f) {
                                            float fL = 1.0f - tj4.l(Math.abs(fAbs / rect2.height()), 0.0f, 1.0f);
                                            float fHeight = (-fAbs) - ((rect2.height() * 0.3f) * (1.0f - (fL * fL)));
                            ...
                            G(coordinatorLayout, appBarLayout, iM, iM < iY ? -1 : 1, false);
                            i4 = i8;
                        } else {
                            this.f = top;
                        }
