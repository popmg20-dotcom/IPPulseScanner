...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    */
    public final View X(View view, int i, ig3 ig3Var, ng3 ng3Var) {
        ...
        if (viewF != null) {
            cq1 cq1Var = (cq1) viewF.getLayoutParams();
            int i5 = cq1Var.e;
            int i6 = cq1Var.f + i5;
            if (super.X(view, i, ig3Var, ng3Var) != null) {
                if ((O0(i) == 1) != this.u) {
                    iV2 = v() - 1;
                    iV = -1;
                    i2 = -1;
                ...
                boolean z = this.p == 1 && a1();
                int iU1 = u1(iV2, ig3Var2, ng3Var2);
                View view3 = null;
                int i7 = -1;
                int i8 = -1;
                int iMin = 0;
                ...
                while (true) {
                    ...
                    int iU12 = u1(i9, ig3Var2, ng3Var2);
                    View viewU = u(i9);
                    if (viewU == viewF) {
                        break;
                    }
                    if (!viewU.hasFocusable() || iU12 == iU1) {
                        cq1 cq1Var2 = (cq1) viewU.getLayoutParams();
                        int i10 = cq1Var2.e;
                        view2 = viewF;
                        int i11 = cq1Var2.f + i10;
                        if (viewU.hasFocusable() && i10 == i5 && i11 == i6) {
                            return viewU;
                        }
                        if (!(viewU.hasFocusable() && view3 == null) && (viewU.hasFocusable() || view5 != null)) {
                            i3 = iV;
                            ...
                            if (viewU.hasFocusable()) {
                                ...
                                i4 = iMin;
                                if (!this.c.w(viewU) || !this.d.w(viewU)) {
                                    if (iMin3 <= iMin2) {
                                        if (iMin3 == iMin2) {
                                            if (z == (i10 > i7)) {
                                            }
                        ...
                        boolean zHasFocusable = viewU.hasFocusable();
                        int i12 = cq1Var2.e;
                        if (zHasFocusable) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean n0(int i, Bundle bundle) {
        View viewU;
        rg3 rg3VarN;
        int iIntValue;
        int i2;
        if (i == i2.m.a() && i != -1) {
            ...
            if (viewU != null && bundle != null) {
                ...
                if (Q.contains(Integer.valueOf(i4)) && (rg3VarN = this.b.N(viewU)) != null) {
                    int iB = rg3VarN.b();
                    int iQ1 = q1(iB);
                    int iP1 = p1(iB);
                    if (iQ1 >= 0 && iP1 >= 0) {
                        if (!r1(iB).contains(Integer.valueOf(this.O)) || !s1(p1(iB), iB).contains(Integer.valueOf(this.P))) {
                            this.O = iQ1;
                            this.P = iP1;
                        }
                        int i5 = this.O;
                        ...
                        if (i4 == 17) {
                            iIntValue = iB - 1;
                            while (iIntValue >= 0) {
                                int iQ12 = q1(iIntValue);
                                int iP12 = p1(iIntValue);
                                if (iQ12 < 0 || iP12 < 0) {
                                    break;
                                }
                                if (this.p != 1) {
                                    if (r1(iIntValue).contains(Integer.valueOf(i5)) && iP12 < iP1) {
                                        this.P = iP12;
                                        break;
                                    }
                                    iIntValue--;
                                } else {
                                    if ((iQ12 == i5 && iP12 < iP1) || iQ12 < i5) {
                                        this.O = iQ12;
                                        this.P = iP12;
                                        break;
                                    }
                            ...
                            iIntValue = iB - 1;
                            while (iIntValue >= 0) {
                                int iQ13 = q1(iIntValue);
                                int iP13 = p1(iIntValue);
                                if (iQ13 < 0 || iP13 < 0) {
                                    break;
                                }
                                if (this.p != 1) {
                                    if (iQ13 < i5 && iP13 == iP1) {
                                        this.O = ((Integer) Collections.max(r1(iIntValue))).intValue();
                                        break;
                                    }
                                    iIntValue--;
                                } else {
                                    if (iQ13 < i5 && s1(p1(iIntValue), iIntValue).contains(Integer.valueOf(iP1))) {
                                        this.O = iQ13;
                                        break;
                                    }
                                    iIntValue--;
                            ...
                            iIntValue = iB + 1;
                            while (iIntValue < F()) {
                                int iQ14 = q1(iIntValue);
                                int iP14 = p1(iIntValue);
                                if (iQ14 < 0 || iP14 < 0) {
                                    break;
                                }
                                if (this.p != 1) {
                                    if (iP14 > iP1 && r1(iIntValue).contains(Integer.valueOf(i5))) {
                                        this.P = iP14;
                                        break;
                                    }
                                    iIntValue++;
                                } else {
                                    if ((iQ14 == i5 && iP14 > iP1) || iQ14 > i5) {
                                        this.O = iQ14;
                                        this.P = iP14;
                                        break;
                                    }
                            ...
                            iIntValue = iB + 1;
                            while (iIntValue < F()) {
                                int iQ15 = q1(iIntValue);
                                int iP15 = p1(iIntValue);
                                if (iQ15 < 0 || iP15 < 0) {
                                    break;
                                }
                                if (this.p != 1) {
                                    ...
                                    if (iQ15 > i5 && (iP15 == iP1 || s1(p1(iIntValue), iIntValue).contains(Integer.valueOf(iP1)))) {
                                        this.O = iQ15;
                                        break;
                                    }
                                    iIntValue++;
            ...
            if (i9 != -1 && i10 != -1) {
                ...
                while (true) {
                    ...
                    RecyclerView recyclerView = this.b;
                    int iV1 = v1(i11, recyclerView.z, recyclerView.y1);
                    RecyclerView recyclerView2 = this.b;
                    int iU1 = u1(i11, recyclerView2.z, recyclerView2.y1);
                    if (this.p != 1) {
                        if (iV1 == i9 && iU1 == i10) {
                            break;
                        }
