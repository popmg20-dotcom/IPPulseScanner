...
public class FileProvider extends ContentProvider {
    ...
    */
    public static ud1 d(int i, Context context, String str) throws XmlPullParserException, IOException {
        File externalStorageDirectory;
        ud1 ud1Var = new ud1(str);
        ProviderInfo providerInfoResolveContentProvider = context.getPackageManager().resolveContentProvider(str, 128);
        if (providerInfoResolveContentProvider == null) {
            xe.k(ha0.n("Couldn't find meta-data for provider with authority ", str));
            return null;
        }
        ...
        if (xmlResourceParserLoadXmlMetaData == null) {
            xe.k("Missing android.support.FILE_PROVIDER_PATHS meta-data");
            return null;
        }
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    ...
                    externalStorageDirectory = externalFilesDirs.length > 0 ? externalFilesDirs[0] : null;
                ...
                if (externalStorageDirectory == null) {
                    ...
                    if (TextUtils.isEmpty(attributeValue)) {
                        xe.k("Name must not be empty");
                        return null;
                    }
                    try {
                        ud1Var.b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e) {
                        a71.j("Failed to resolve canonical path for ", externalStorageDirectory, e);
                        return null;
                    }
                }
            }
