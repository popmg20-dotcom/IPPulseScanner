...
public class SlidingPaneLayout extends ViewGroup {
    ...
    */
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean zC = c();
        int i10 = i3 - i;
        int paddingRight = zC ? getPaddingRight() : getPaddingLeft();
        int paddingLeft = zC ? getPaddingLeft() : getPaddingRight();
        int paddingTop = getPaddingTop();
        int childCount = getChildCount();
        if (this.L0) {
            this.A0 = (this.y0 && this.K0) ? 0.0f : 1.0f;
        }
        int i11 = paddingRight;
        for (int i12 = 0; i12 < childCount; i12++) {
            View childAt = getChildAt(i12);
            if (childAt.getVisibility() != 8) {
                ey3 ey3Var = (ey3) childAt.getLayoutParams();
                int measuredWidth = childAt.getMeasuredWidth();
                if (ey3Var.b) {
                    int i13 = i10 - paddingLeft;
                    int iMin = (Math.min(paddingRight, i13) - i11) - (((ViewGroup.MarginLayoutParams) ey3Var).leftMargin + ((ViewGroup.MarginLayoutParams) ey3Var).rightMargin);
                    this.C0 = iMin;
                    int i14 = zC ? ((ViewGroup.MarginLayoutParams) ey3Var).rightMargin : ((ViewGroup.MarginLayoutParams) ey3Var).leftMargin;
                    ey3Var.c = (measuredWidth / 2) + ((i11 + i14) + iMin) > i13;
                    float f = iMin;
                    int i15 = (int) (this.A0 * f);
                    i5 = i14 + i15 + i11;
                    this.A0 = i15 / f;
                } else if (!this.y0 || (i6 = this.E0) == 0) {
                    i5 = paddingRight;
                } else {
                    i7 = (int) ((1.0f - this.A0) * i6);
                    i5 = paddingRight;
                    if (zC) {
                        i8 = i5 - i7;
                        i9 = i8 + measuredWidth;
                    ...
                    if (cr1Var == null) {
                        ...
                        int iA = yoVar.a();
                        sh1 sh1Var = sh1.z;
                        int iWidth = ((iB > iA ? sh1.A : sh1Var) == sh1Var && this.P0.a()) ? this.P0.a.c().width() : 0;
    ...
    */
    public final void onMeasure(int i, int i2) {
        ...
        int childCount = getChildCount();
        if (childCount > 2) {
            a1.d("SlidingPaneLayout", "onMeasure: More than two child views are not supported.");
        }
        this.z0 = null;
        int i7 = 0;
        boolean z = false;
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (f2 > 0.0f) {
                    f += f2;
                    if (((ViewGroup.MarginLayoutParams) ey3Var).width != 0) {
                        int iMax3 = Math.max(iMax2 - (((ViewGroup.MarginLayoutParams) ey3Var).leftMargin + ((ViewGroup.MarginLayoutParams) ey3Var).rightMargin), (int) r7);
                        int i9 = ((ViewGroup.MarginLayoutParams) ey3Var).width;
                        if (i9 == -2) {
                            iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(iMax3, mode == 0 ? mode : Integer.MIN_VALUE);
                        } else {
                            iMakeMeasureSpec2 = i9 == -1 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode) : View.MeasureSpec.makeMeasureSpec(i9, Pow2.MAX_POW2);
                        }
                        childAt.measure(iMakeMeasureSpec2, ViewGroup.getChildMeasureSpec(i2, getPaddingBottom() + getPaddingTop(), ((ViewGroup.MarginLayoutParams) ey3Var).height));
                        int measuredWidth = childAt.getMeasuredWidth();
        ...
        if (z || f > 0.0f) {
            ...
            while (i11 < childCount) {
                ...
                if (childAt2.getVisibility() == i3) {
                    ...
                    ey3 ey3Var2 = (ey3) childAt2.getLayoutParams();
                    int measuredWidth2 = (((ViewGroup.MarginLayoutParams) ey3Var2).width != 0 || ey3Var2.a <= 0.0f) ? childAt2.getMeasuredWidth() : 0;
                    if (z) {
                        iMax = iMax2 - (((ViewGroup.MarginLayoutParams) ey3Var2).leftMargin + ((ViewGroup.MarginLayoutParams) ey3Var2).rightMargin);
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, Pow2.MAX_POW2);
                    } else if (ey3Var2.a > 0.0f) {
                        iMax = ((int) ((ey3Var2.a * Math.max(0, i8)) / f)) + measuredWidth2;
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, Pow2.MAX_POW2);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
                    ...
                    ey3 ey3Var3 = (ey3) childAt2.getLayoutParams();
                    i4 = i11;
                    int iMakeMeasureSpec3 = (((ViewGroup.MarginLayoutParams) ey3Var3).width != 0 || ey3Var3.a <= 0.0f) ? View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Pow2.MAX_POW2) : ViewGroup.getChildMeasureSpec(i2, paddingBottom, ((ViewGroup.MarginLayoutParams) ey3Var3).height);
        ...
        cr1 cr1Var = this.P0;
        if (cr1Var == null || !cr1Var.a() || this.P0.a.c().left == 0 || this.P0.a.c().top != 0) {
            arrayList = null;
        } else {
            cr1 cr1Var2 = this.P0;
            int[] iArr = new int[2];
            ...
            int i12 = iArr[0];
            Rect rect = new Rect(i12, iArr[1], getWidth() + i12, getWidth() + iArr[1]);
            Rect rect2 = new Rect(cr1Var2.a.c());
        ...
        if (arrayList != null && !z) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    ey3 ey3Var4 = (ey3) childAt3.getLayoutParams();
                    int i14 = ((ViewGroup.MarginLayoutParams) ey3Var4).leftMargin + ((ViewGroup.MarginLayoutParams) ey3Var4).rightMargin;
                    int iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(childAt3.getMeasuredHeight(), Pow2.MAX_POW2);
                    childAt3.measure(View.MeasureSpec.makeMeasureSpec(rect4.width(), Integer.MIN_VALUE), iMakeMeasureSpec4);
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) != i10) {
                        boolean z3 = childAt3 instanceof hy3;
                        if (z3) {
                            i6 = 0;
                            View childAt4 = ((hy3) childAt3).getChildAt(0);
                            WeakHashMap weakHashMap = wp4.a;
                        ...
                        if (minimumWidth != 0) {
                            if (rect4.width() < (z3 ? ((hy3) childAt3).getChildAt(i6).getMinimumWidth() : childAt3.getMinimumWidth())) {
                            }
                        }
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(rect4.width(), Pow2.MAX_POW2), iMakeMeasureSpec4);
                    }
                    childAt3.measure(View.MeasureSpec.makeMeasureSpec(iMax2 - i14, Pow2.MAX_POW2), iMakeMeasureSpec4);
                    if (i13 != 0) {
                        i5 = 1;
                        ey3Var4.b = true;
                        this.z0 = childAt3;
