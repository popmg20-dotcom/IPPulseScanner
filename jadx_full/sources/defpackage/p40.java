...
public final class p40 extends yi2 implements Drawable.Callback, nb4 {
    ...
    */
    public final boolean H(int[] iArr, int[] iArr2) {
        ...
        int iC = c(colorStateList2 != null ? colorStateList2.getColorForState(iArr, this.M1) : 0);
        boolean state = true;
        if (this.M1 != iC) {
            this.M1 = iC;
            zOnStateChange = true;
        ...
        int iC2 = c(colorStateList3 != null ? colorStateList3.getColorForState(iArr, this.N1) : 0);
        if (this.N1 != iC2) {
            this.N1 = iC2;
            zOnStateChange = true;
        }
        int iC3 = u70.c(iC2, iC);
        if ((this.O1 != iC3) | (this.f.c == null)) {
            this.O1 = iC3;
            p(ColorStateList.valueOf(iC3));
            zOnStateChange = true;
        }
        ColorStateList colorStateList4 = this.c1;
        int colorForState2 = colorStateList4 != null ? colorStateList4.getColorForState(iArr, this.P1) : 0;
        ...
        if (this.a2 != null) {
            ...
            colorForState = (z3 && z4) ? this.a2.getColorForState(iArr, this.Q1) : 0;
        }
        if (this.Q1 != colorForState) {
            this.Q1 = colorForState;
        }
        kb4 kb4Var = this.L1.g;
        int colorForState3 = (kb4Var == null || (colorStateList = kb4Var.k) == null) ? 0 : colorStateList.getColorForState(iArr, this.R1);
        ...
        int colorForState4 = colorStateList5 != null ? colorStateList5.getColorForState(iArr, this.T1) : 0;
        if (this.T1 != colorForState4) {
            this.T1 = colorForState4;
            ColorStateList colorStateList6 = this.X1;
            PorterDuff.Mode mode = this.Y1;
            this.W1 = (colorStateList6 == null || mode == null) ? null : new PorterDuffColorFilter(colorStateList6.getColorForState(getState(), 0), mode);
        } else {
            state = zOnStateChange;
        }
        if (F(this.h1)) {
            state |= this.h1.setState(iArr);
        }
        if (F(this.t1)) {
            state |= this.t1.setState(iArr);
        }
        if (F(this.m1)) {
            int[] iArr4 = new int[iArr.length + iArr2.length];
            System.arraycopy(iArr, 0, iArr4, 0, iArr.length);
            System.arraycopy(iArr2, 0, iArr4, iArr.length, iArr2.length);
            state |= this.m1.setState(iArr4);
        }
        if (F(this.n1)) {
            state |= this.n1.setState(iArr2);
        }
        if (state) {
            invalidateSelf();
        }
