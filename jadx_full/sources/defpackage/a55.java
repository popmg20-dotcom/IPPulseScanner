...
public final class a55 implements Application.ActivityLifecycleCallbacks {
    ...
    */
    public void c(k45 k45Var, Bundle bundle) {
        Uri uri;
        ...
        try {
            try {
                t65 t65Var = k85Var.Y;
                k85.h(t65Var);
                t65Var.H0.a("onActivityCreated");
                Intent intent = k45Var.z;
                if (intent != null) {
                    ...
                    if (data == null || !data.isHierarchical()) {
                        ...
                        if (extras != null) {
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                ...
                                if (uri != null && uri.isHierarchical()) {
                                    ...
                                    f85 f85Var = k85Var.Z;
                                    k85.h(f85Var);
                                    f85Var.e1(new ia5(this, z, uri, str, queryParameter));
                                }
                            }
                        }
                        uri = null;
                        if (uri != null) {
                            ...
                            if ("android-app://com.google.android.googlequicksearchbox/https/www.google.com".equals(stringExtra2)) {
                                ...
                                k85.h(f85Var2);
                                f85Var2.e1(new ia5(this, z2, uri, str2, queryParameter2));
                            }
                        }
                    } else {
                        uri = data;
                ...
                k85.h(t65Var2);
                t65Var2.z0.b(e, "Throwable caught in onActivityCreated");
            }
        } finally {
            yb5 yb5Var = k85Var.C0;
            k85.g(yb5Var);
            yb5Var.d1(k45Var, bundle);
        }
    }
