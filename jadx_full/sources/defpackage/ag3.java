...
public abstract class ag3 {
    ...
    */
    public static int w(int i, int i2, int i3, boolean z, int i4) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean o0(ig3 ig3Var, ng3 ng3Var, int i, Bundle bundle) {
        int iJ;
        int iH;
        float f;
        if (this.b != null) {
            ...
            if (i != 4096) {
                if (i != 8192) {
                    ...
                    iH = this.b.canScrollHorizontally(-1) ? -((iWidth - H()) - I()) : 0;
                }
                if (iJ == 0 || iH != 0) {
                    if (bundle == null) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean t0(RecyclerView recyclerView, View view, Rect rect, boolean z, boolean z2) {
        int iH = H();
        int iJ = J();
        int I = this.n - I();
        int iG = this.o - G();
        ...
        if (z2) {
            ...
            if (focusedChild != null) {
                ...
                int I2 = this.n - I();
                int iG2 = this.o - G();
                Rect rect2 = this.b.D0;
                z(focusedChild, rect2);
                if (rect2.left - i4 < I2 && rect2.right - i4 > iH2 && rect2.top - i5 < iG2 && rect2.bottom - i5 > iJ2) {
                }
            }
        } else if (i4 != 0 || i5 != 0) {
            if (z) {
