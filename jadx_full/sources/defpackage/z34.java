...
public final class z34 extends in4 {
    ...
    */
    public final mn4 t(kz kzVar, ln4 ln4Var) {
        ...
        es4 es4Var = this.q;
        HashSet hashSet = es4Var.z0;
        uj3 uj3Var = es4Var.B0;
        List listO = uj3Var.f.o(34);
        HashSet<mn4> hashSet2 = uj3Var.d;
        for (mn4 mn4Var : hashSet2) {
            if (!mn4Var.z() && (mn4Var instanceof hy1)) {
                ((hy1) mn4Var).B();
            }
        }
        List list = (List) qn2VarA.p(hy1.E, null);
        if (list != null) {
            ...
            while (true) {
                ...
                if (((Integer) pair.first).equals(34)) {
                    listO = Arrays.asList((Size[]) pair.second);
                    break;
                }
            }
        }
        Rational rational = uj3Var.c;
        ArrayList arrayList = new ArrayList();
        HashSet hashSet3 = new HashSet();
        Iterator it2 = hashSet2.iterator();
        while (it2.hasNext()) {
            hashSet3.addAll(uj3Var.c((mn4) it2.next()));
        }
        ...
        while (true) {
            ...
            if (!af.a(rational, (Size) it3.next())) {
                arrayList.addAll(uj3Var.g(uj3Var.b, listO, false));
                break;
            }
        }
        ...
        if (!hashSet2.isEmpty()) {
            ...
            loop4: while (true) {
                ...
                Iterator it5 = uj3Var.c((mn4) it4.next()).iterator();
                boolean z = false;
                boolean z2 = false;
                while (true) {
                    if (!it5.hasNext()) {
                    ...
                    boolean zA = af.a(rational, (Size) it5.next());
                    if (zA) {
                        z = true;
                    }
                    if (z2 && zA) {
        ...
        arrayList.addAll(size, uj3Var.g(rational, listO, false));
        arrayList.addAll(uj3Var.f(listO, false));
        if (arrayList.isEmpty()) {
            ez4.a0("ResolutionsMerger", "Failed to find a parent resolution that does not result in double-cropping, this might due to camera not supporting 4:3 and 16:9resolutions or a strict ResolutionSelector settings. Starting resolution selection process with resolutions that might have a smaller FOV.");
            arrayList.addAll(uj3Var.f(listO, true));
        }
        ez4.o("ResolutionsMerger", "Parent resolutions: " + arrayList);
        qn2VarA.g(hy1.G, arrayList);
        pg pgVar = mn4.e0;
        Iterator it6 = hashSet.iterator();
        int iMax = 0;
        while (it6.hasNext()) {
            iMax = Math.max(iMax, ((mn4) it6.next()).w());
        }
        qn2VarA.g(pgVar, Integer.valueOf(iMax));
        ArrayList arrayList2 = new ArrayList();
        Iterator it7 = hashSet.iterator();
        while (it7.hasNext()) {
            arrayList2.add(((mn4) it7.next()).e());
        }
        if (arrayList2.isEmpty()) {
            oz0Var = null;
            break;
        }
        oz0 oz0Var2 = (oz0) arrayList2.get(0);
        Integer numValueOf = Integer.valueOf(oz0Var2.a);
        Integer numValueOf2 = Integer.valueOf(oz0Var2.b);
        for (int i = 1; i < arrayList2.size(); i++) {
            oz0 oz0Var3 = (oz0) arrayList2.get(i);
            Integer numValueOf3 = Integer.valueOf(oz0Var3.a);
            if (!numValueOf.equals(0)) {
                if (!numValueOf3.equals(0)) {
                ...
                Integer numValueOf4 = Integer.valueOf(oz0Var3.b);
        ...
        oz0Var = new oz0(numValueOf.intValue(), numValueOf2.intValue());
        if (oz0Var == null) {
            xe.k("Failed to merge child dynamic ranges, can not find a dynamic range that satisfies all children.");
            return null;
        }
        qn2VarA.g(dy1.u, oz0Var);
        pg pgVar2 = mn4.g0;
        Range rangeExtend = ih.h;
        Iterator it8 = hashSet.iterator();
        while (it8.hasNext()) {
            Range rangeO = ((mn4) it8.next()).O(rangeExtend);
            Objects.requireNonNull(rangeO);
            if (ih.h.equals(rangeExtend)) {
                rangeExtend = rangeO;
            } else {
                try {
                    rangeExtend = rangeExtend.intersect(rangeO);
                } catch (IllegalArgumentException unused) {
                    ez4.o("VirtualCameraAdapter", "No intersected frame rate can be found from the target frame rate settings of the UseCases! Resolved: " + rangeExtend + " <<>> " + rangeO);
                    rangeExtend = rangeExtend.extend(rangeO);
                }
            }
        }
        qn2VarA.g(pgVar2, rangeExtend);
        Iterator it9 = es4Var.b.iterator();
        while (it9.hasNext()) {
            mn4 mn4Var2 = (mn4) es4Var.A0.get((in4) it9.next());
            Objects.requireNonNull(mn4Var2);
            if (mn4Var2.N() != 0) {
                qn2VarA.g(mn4.m0, Integer.valueOf(mn4Var2.N()));
            }
            if (mn4Var2.W() != 0) {
                qn2VarA.g(mn4.l0, Integer.valueOf(mn4Var2.W()));
            }
        }
        return ln4Var.b();
    }
