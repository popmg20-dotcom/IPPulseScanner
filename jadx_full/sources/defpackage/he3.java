...
public final class he3 implements cq {
    ...
    */
    public final long n(byte b, long j, long j2) {
        ...
        if (0 > j2) {
            e04.f(ha0.j(j2, "fromIndex=0 toIndex="));
            return 0L;
        }
        long jMax = 0;
        while (jMax < j2) {
            hp hpVar = this.f;
            if (j6 > jMax || jMax > j2) {
                throw new IllegalArgumentException(("size=" + hpVar.f + " fromIndex=" + jMax + " toIndex=" + j2).toString());
            }
            long j7 = hpVar.f;
            long j8 = j2 > j7 ? j7 : j2;
            if (jMax == j8 || (rr3Var = hpVar.b) == null) {
                j3 = j6;
            } else {
                if (j7 - jMax < jMax) {
                    while (j7 > jMax) {
                    ...
                    while (j7 < j8) {
                        ...
                        byte[] bArr = rr3Var.a;
                        long j10 = j9;
                        int iMin = (int) Math.min(rr3Var.c, (((long) rr3Var.b) + j8) - j7);
                        for (int i = (int) ((((long) rr3Var.b) + j10) - j7); i < iMin; i++) {
                            if (bArr[i] == b) {
                                j5 = ((long) (i - rr3Var.b)) + j7;
                                break;
                            }
                        }
                        j9 = ((long) (rr3Var.c - rr3Var.b)) + j7;
                        rr3Var = rr3Var.f;
                        rr3Var.getClass();
                        j7 = j9;
                    }
                    ...
                    j4 = -1;
                    while (true) {
                        long j11 = ((long) (rr3Var.c - rr3Var.b)) + j6;
                        if (j11 > jMax) {
                            break;
                        }
                        rr3Var = rr3Var.f;
                    ...
                    while (j6 < j8) {
                        byte[] bArr2 = rr3Var.a;
                        long j13 = j6;
                        int iMin2 = (int) Math.min(rr3Var.c, (((long) rr3Var.b) + j8) - j13);
                        for (int i2 = (int) ((((long) rr3Var.b) + j12) - j13); i2 < iMin2; i2++) {
                            if (bArr2[i2] == b) {
                                j5 = ((long) (i2 - rr3Var.b)) + j13;
                                break;
                            }
                        }
                        j12 = j13 + ((long) (rr3Var.c - rr3Var.b));
                        rr3Var = rr3Var.f;
                        rr3Var.getClass();
                        j6 = j12;
                    }
                ...
                long j14 = hpVar.f;
                if (j14 >= j2 || this.b.t0(hpVar, 8192L) == j4) {
                    return j4;
                }
