    ...
    */
    public final Drawable n(Context context, int i2, boolean z, Drawable drawable) {
        ...
        if (colorStateListI != null) {
            ...
            drawableMutate.setTintList(colorStateListI);
        ...
        if (cm2Var != null) {
            if (i2 == R.drawable.abc_seekbar_track_material) {
                ...
                int iC = id4.c(context, R.attr.colorControlNormal);
                PorterDuff.Mode mode2 = db.b;
                cm2.A(drawableFindDrawableByLayerId, iC, mode2);
                cm2.A(layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress), id4.c(context, R.attr.colorControlNormal), mode2);
                cm2.A(layerDrawable.findDrawableByLayerId(android.R.id.progress), id4.c(context, R.attr.colorControlActivated), mode2);
                return drawable;
            }
            if (i2 == R.drawable.abc_ratingbar_material || i2 == R.drawable.abc_ratingbar_indicator_material || i2 == R.drawable.abc_ratingbar_small_material) {
                ...
                int iB = id4.b(context, R.attr.colorControlNormal);
                PorterDuff.Mode mode3 = db.b;
                cm2.A(drawableFindDrawableByLayerId2, iB, mode3);
                cm2.A(layerDrawable2.findDrawableByLayerId(android.R.id.secondaryProgress), id4.c(context, R.attr.colorControlActivated), mode3);
                cm2.A(layerDrawable2.findDrawableByLayerId(android.R.id.progress), id4.c(context, R.attr.colorControlActivated), mode3);
                return drawable;
            }
        }
        cm2 cm2Var2 = this.g;
        boolean z3 = false;
        if (cm2Var2 != null) {
            PorterDuff.Mode mode4 = db.b;
            if (cm2.c((int[]) cm2Var2.f, i2)) {
                z2 = true;
                iRound = -1;
                if (z2) {
                }
            } else {
                if (cm2.c((int[]) cm2Var2.A, i2)) {
                    i3 = R.attr.colorControlActivated;
                } else {
                    boolean zC = cm2.c((int[]) cm2Var2.X, i2);
                    ...
                    if (zC) {
                        ...
                        if (z2) {
                            ...
                            drawableMutate2.setColorFilter(db.c(id4.c(context, i3), mode4));
                            if (iRound != -1) {
