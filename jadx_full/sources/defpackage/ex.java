...
public final class ex implements mz {
    ...
    */
    public final void H(int i, mg mgVar, boolean z) {
        lz lzVar;
        lz lzVar2;
        c00 c00VarA;
        HashMap map = null;
        w("Transitioning camera internal state: " + fw.H(this.c1) + " --> " + fw.H(i), null);
        if (vo.A()) {
            vo.L(fw.G(i), "CX:C2State[" + this + "]");
            if (mgVar != null) {
                this.H0++;
            }
            if (this.H0 > 0) {
                vo.L(mgVar != null ? mgVar.a : 0, "CX:C2StateErrorCode[" + this + "]");
            }
        }
        this.c1 = i;
        switch (fw.G(i)) {
            ...
            case 10:
                ...
                break;
            default:
                xe.q("Unknown state: ".concat(fw.H(i)));
                return;
        }
        d00 d00Var = this.K0;
        synchronized (d00Var.b) {
            try {
                int i2 = d00Var.f;
                lz lzVar3 = lz.RELEASED;
                HashMap map2 = d00Var.e;
                if (lzVar == lzVar3) {
                    c00 c00Var = (c00) map2.remove(this);
                    if (c00Var != null) {
                        d00Var.b();
                        lzVar2 = c00Var.a;
                    } else {
                    ...
                    c00 c00Var2 = (c00) map2.get(this);
                    r25.i(c00Var2, "Cannot update state of camera which has not yet been registered. Register with CameraStateRegistry.registerCamera()");
                    lz lzVar4 = c00Var2.a;
                    c00Var2.a = lzVar;
                    lz lzVar5 = lz.OPENING;
                    if (lzVar == lzVar5) {
                        r25.j("Cannot mark camera as opening until camera was successful at calling CameraStateRegistry.tryOpenCamera()", lzVar.b || lzVar4 == lzVar5);
                    }
                    if (lzVar4 != lzVar) {
                        d00.c(this, lzVar);
                        d00Var.b();
                ...
                if (lzVar2 != lzVar) {
                    if (d00Var.d.b() == 2 && lzVar == lz.CONFIGURED) {
                        String strC = d00Var.d.c(this.z0.d());
                        if (strC != null) {
                            c00VarA = d00Var.a(strC);
                        }
                        if (i2 >= 1) {
                            if (lzVar == lz.PENDING_OPEN) {
                                map = new HashMap();
                                map.put(this, (c00) d00Var.e.get(this));
                            }
                            if (map != null) {
                                map.remove(this);
                            }
                        ...
                        if (i2 >= 1 && d00Var.f > 0) {
                            map = new HashMap();
                            for (Map.Entry entry : d00Var.e.entrySet()) {
                                if (((c00) entry.getValue()).a == lz.PENDING_OPEN) {
                                    map.put((wx) entry.getKey(), (c00) entry.getValue());
                                }
                            }
                        } else if (lzVar == lz.PENDING_OPEN && d00Var.f > 0) {
                            map = new HashMap();
                            map.put(this, (c00) d00Var.e.get(this));
                        }
                        if (map != null && !z) {
                        ...
                        if (map != null) {
                            for (c00 c00Var3 : map.values()) {
                                c00Var3.getClass();
                                try {
                                    c00Var3.b.execute(new d4(7, c00Var3.d));
                                } catch (RejectedExecutionException e) {
                                    ez4.r("CameraStateRegistry", "Unable to notify camera to open.", e);
                                }
                            }
                        }
                        if (c00VarA != null) {
                            try {
                                c00VarA.b.execute(new d4(8, c00VarA.c));
                            } catch (RejectedExecutionException e2) {
                                ez4.r("CameraStateRegistry", "Unable to notify camera to configure.", e2);
                            }
                        }
                    }
                }
        ...
        ((on2) this.X.f).i(new ad2(lzVar));
        this.Y.S(lzVar, mgVar);
    }
    ...
    */
    public final void s() {
        e24 e24Var = this.b;
        st3 st3VarR = e24Var.r();
        LinkedHashMap linkedHashMap = (LinkedHashMap) e24Var.z;
        tt3 tt3VarB = st3VarR.b();
        int size = DesugarCollections.unmodifiableList(tt3VarB.g.a).size();
        int size2 = tt3VarB.b().size();
        cm2 cm2Var = this.R0;
        boolean z = false;
        if (cm2Var == null ? false : e24Var.v(z(cm2Var))) {
            boolean z2 = size != 1 || size2 == 1;
            if (z2 || B(this.R0)) {
                if (this.R0 != null) {
                    StringBuilder sb = new StringBuilder("MeteringRepeating");
                    this.R0.getClass();
                    sb.append(this.R0.hashCode());
                    String string = sb.toString();
                    if (linkedHashMap.containsKey(string)) {
                        jn4 jn4Var = (jn4) linkedHashMap.get(string);
                        jn4Var.e = false;
                        if (!jn4Var.f) {
                    ...
                    if (linkedHashMap.containsKey(string2)) {
                        jn4 jn4Var2 = (jn4) linkedHashMap.get(string2);
                        jn4Var2.f = false;
                        if (!jn4Var2.e) {
                    ...
                    cm2 cm2Var2 = this.R0;
                    cm2Var2.getClass();
                    ez4.o("MeteringRepeating", "MeteringRepeating clear!");
                    az1 az1Var = (az1) cm2Var2.f;
                    if (az1Var != null) {
                        az1Var.a();
                    }
                    cm2Var2.f = null;
            ...
            cm2 cm2Var3 = this.R0;
            if (cm2Var3 == null) {
                cm2Var3 = new cm2(this.z0.b, this.Y0, new sw(this, 2));
                this.R0 = cm2Var3;
            }
            if (!B(cm2Var3)) {
                cm2 cm2Var4 = this.R0;
                if (cm2Var4 != null) {
                    String strZ = z(cm2Var4);
                    cm2 cm2Var5 = this.R0;
                    tt3 tt3Var = (tt3) cm2Var5.z;
                    bm2 bm2Var = (bm2) cm2Var5.A;
                    on4 on4Var = on4.Y;
                    List listSingletonList = Collections.singletonList(on4Var);
                    LinkedHashMap linkedHashMap2 = (LinkedHashMap) e24Var.z;
                    jn4 jn4Var3 = (jn4) linkedHashMap2.get(strZ);
                    if (jn4Var3 == null) {
                        jn4Var3 = new jn4(tt3Var, bm2Var, null, listSingletonList);
                        linkedHashMap2.put(strZ, jn4Var3);
                    }
                    jn4Var3.e = true;
                    e24Var.H(strZ, tt3Var, bm2Var, null, listSingletonList);
                    cm2 cm2Var6 = this.R0;
                    tt3 tt3Var2 = (tt3) cm2Var6.z;
                    bm2 bm2Var2 = (bm2) cm2Var6.A;
                    List listSingletonList2 = Collections.singletonList(on4Var);
                    LinkedHashMap linkedHashMap3 = (LinkedHashMap) e24Var.z;
                    jn4 jn4Var4 = (jn4) linkedHashMap3.get(strZ);
                    if (jn4Var4 == null) {
                        jn4Var4 = new jn4(tt3Var2, bm2Var2, null, listSingletonList2);
                        linkedHashMap3.put(strZ, jn4Var4);
                    }
                    jn4Var4.f = true;
                }
                z = true;
        ...
        ez4.q("Camera2CameraImpl", "The repeating surface is missing, CameraControl and ImageCapture may encounter issues due to the absence of repeating surface. Please add a UseCase (Preview or ImageAnalysis) that can provide a repeating surface for CameraControl and ImageCapture to function properly.");
    }
