            ...
            case 0:
                ...
                while (true) {
                    ...
                    if (i6 >= 4) {
                        ...
                        c2 = 5;
                        bArr = null;
                        qtVar = new qt(cnVarU, new ArrayList(), i5);
                    } else {
                        int i7 = iArr[i6];
                        int i8 = i7 % 360;
                        if (i8 == 0) {
                            ...
                            if (i8 != 0) {
                                if (i8 == 90) {
                                    ...
                                    if (i8 != 270) {
                                        xe.k("degrees must be a multiple of 0, 90, 180, or 270");
                                        return null;
                                    }
                                    cnVar.e();
                                    cnVar.d();
                        ...
                        if (i12 > 0) {
                            int i13 = cnVar.b;
                            xk3[] xk3VarArr4 = new xk3[8];
                            int i14 = 0;
                            int i15 = 0;
                            int iMax = 10;
                            cn cnVar2 = cnVar;
                            xk3[] xk3VarArrL = xb5.l(cnVar2, i12, i13, 0, 0, 10, xb5.z);
                            int[] iArr3 = xb5.b;
                            for (int i16 = i2; i16 < 4; i16++) {
                                xk3VarArr4[iArr3[i16]] = xk3VarArrL[i16];
                            }
                            xk3 xk3Var = xk3VarArr4[4];
                            if (xk3Var != null) {
                                int i17 = (int) xk3Var.a;
                                int i18 = (int) xk3Var.b;
                                if (xk3VarArr4[c2] != null) {
                                    i14 = i18;
                                    i15 = i17;
                                    iMax = (int) Math.max((((int) r11.b) - i18) * 0.5f, 10.0f);
                                } else {
                                    i14 = i18;
                                    i15 = i17;
                                }
                            }
                            xk3[] xk3VarArrL2 = xb5.l(cnVar2, i12, i13, i14, i15, iMax, xb5.A);
                            cnVar = cnVar2;
                            int[] iArr4 = xb5.f;
                            for (int i19 = i2; i19 < 4; i19++) {
                                xk3VarArr4[iArr4[i19]] = xk3VarArrL2[i19];
                            }
                            if (xk3VarArr4[i2] != null || xk3VarArr4[c] != null) {
                                arrayList2.add(xk3VarArr4);
                            }
                        }
                        if (!arrayList2.isEmpty()) {
                            qtVar = new qt(cnVar, arrayList2, i7);
                        } else {
                            i6++;
                            i4 = i;
                            i5 = i2;
                ...
                break;
            default:
                qt0 qt0Var = new qt0(lbVar.u());
                try {
                    whVarA = qt0Var.a(false);
                    xk3VarArr = whVarA.b;
                    break;
                } catch (qi1 e) {
                    e = e;
                ...
                try {
                    i5 = whVarA.f;
                    pk0VarA = new lk0().a(whVarA);
                    xk3VarArr2 = xk3VarArr;
                    qs2Var = null;
                } catch (qi1 e3) {
                    e = e3;
                    qi1Var = e;
                    ...
                    String str2 = pk0VarA.b;
                    byte[] bArr2 = pk0VarA.a;
                    System.currentTimeMillis();
                    vk3 vk3Var = new vk3(str2, bArr2, xk3VarArr3, sj.b, 0);
                    list = pk0VarA.c;
                    if (list != null) {
                    }
                    str = pk0VarA.d;
                    ...
                    vk3Var.b(wk3Var2, Integer.valueOf(pk0VarA.e.intValue() + i5));
                    vk3Var.b(wk3Var, "]z" + pk0VarA.j);
                    return vk3Var;
                } catch (qs2 e4) {
                    e = e4;
                    xk3[] xk3VarArr5 = xk3VarArr;
                    qs2Var = e;
                    xk3VarArr2 = xk3VarArr5;
                    pk0VarA = null;
                }
                qi1Var = null;
                if (pk0VarA != null) {
                    try {
                        wh whVarA2 = qt0Var.a(true);
                        xk3[] xk3VarArr6 = whVarA2.b;
                        i5 = whVarA2.f;
                        pk0VarA = new lk0().a(whVarA2);
                        xk3VarArr3 = xk3VarArr6;
                    } catch (qi1 | qs2 e5) {
                        if (qs2Var != null) {
                            throw qs2Var;
                        }
                    ...
                    xk3VarArr3 = xk3VarArr2;
                }
                String str22 = pk0VarA.b;
                byte[] bArr22 = pk0VarA.a;
                System.currentTimeMillis();
                vk3 vk3Var2 = new vk3(str22, bArr22, xk3VarArr3, sj.b, 0);
                list = pk0VarA.c;
                if (list != null) {
                    vk3Var2.b(wk3.f, list);
                }
                str = pk0VarA.d;
                if (str != null) {
                    vk3Var2.b(wk3Var3, str);
                }
                vk3Var2.b(wk3Var2, Integer.valueOf(pk0VarA.e.intValue() + i5));
                vk3Var2.b(wk3Var, "]z" + pk0VarA.j);
                return vk3Var2;
        }
    }
