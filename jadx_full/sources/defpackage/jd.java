    ...
    */
    public boolean c(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            bc1Var.n = x;
            bc1Var.o = y;
            if (view.getAlpha() > 0.0f && bc1Var.d(view, x, y)) {
                bc1Var.q = y;
                bc1Var.r = bc1Var.m;
                bc1Var.h(true);
            }
            ...
            if (!bc1Var.s && bc1Var.d(bc1Var.i, bc1Var.n, bc1Var.o) && Math.abs(y - bc1Var.o) > bc1Var.b) {
                if (bc1Var.d(view, bc1Var.n, bc1Var.o)) {
                    bc1Var.q = bc1Var.p;
                    bc1Var.r = bc1Var.m;
                } else {
                    bc1Var.q = y;
                    int i = (int) ((y - rectA.top) - (bc1Var.h / 2.0f));
                    bc1Var.r = i;
                    bc1Var.g(i);
                }
                bc1Var.h(true);
            ...
            if (bc1Var.s) {
                bc1Var.g(bc1Var.r + ((int) (y - bc1Var.q)));
            }
        } else if (action == 3) {
        }
        bc1Var.p = y;
