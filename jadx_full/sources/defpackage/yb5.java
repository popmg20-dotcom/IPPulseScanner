...
public final class yb5 extends u55 {
    ...
    */
    public final void f1(rb5 rb5Var, rb5 rb5Var2, long j, boolean z, Bundle bundle) {
        boolean z2;
        boolean z3 = rb5Var.e;
        k85 k85Var = (k85) this.f;
        V0();
        boolean z4 = false;
        if (rb5Var2 != null) {
            z2 = (rb5Var2.c == rb5Var.c && Objects.equals(rb5Var2.b, rb5Var.b) && Objects.equals(rb5Var2.a, rb5Var.a)) ? false : true;
        }
        if (z && this.y0 != null) {
            z4 = true;
        }
        if (z2) {
            ...
            qf5.O1(rb5Var, bundle2, true);
            if (rb5Var2 != null) {
                String str = rb5Var2.a;
                if (str != null) {
                    bundle2.putString("_pn", str);
                }
                String str2 = rb5Var2.b;
                if (str2 != null) {
                    bundle2.putString("_pc", str2);
                }
                bundle2.putLong("_pi", rb5Var2.c);
            }
            if (z4) {
                zd5 zd5Var = k85Var.y0;
                k85.g(zd5Var);
            ...
            k85.g(ib5Var);
            ib5Var.d1(jCurrentTimeMillis, bundle2, str3, "_vs");
        }
        if (z4) {
            Z0(this.y0, true, j);
        }
        ...
        dd5VarJ.V0();
        dd5VarJ.W0();
        dd5VarJ.j1(new um1(dd5VarJ, rb5Var));
    }
}
