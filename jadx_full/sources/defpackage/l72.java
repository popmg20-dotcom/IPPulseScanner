...
public abstract class l72 {
    ...
    public static InetSocketAddress Q(int i, int i2, byte[] bArr) throws UnknownHostException {
    ...
    public static y44 R(byte[] bArr, int i, byte[] bArr2) throws UnknownHostException {
        int i2;
        e03 e03Var;
        int i3 = i;
        int i4 = 20;
    ...
    */
    public static Type V(Type type, Class cls, Type type2, HashMap map) {
        Type lq1Var;
        ...
        while (true) {
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (cls4.isArray()) {
                    ...
                    Type typeV2 = V(type, cls, componentType, map);
                    if (Objects.equals(componentType, typeV2)) {
                        type2 = cls4;
                    } else {
                        lq1Var = new kq1(typeV2);
                        type2 = lq1Var;
                    }
                } else if (type2 instanceof GenericArrayType) {
                    type2 = (GenericArrayType) type2;
                    Type genericComponentType = type2.getGenericComponentType();
                    Type typeV3 = V(type, cls, genericComponentType, map);
                    if (!Objects.equals(genericComponentType, typeV3)) {
                        lq1Var = new kq1(typeV3);
                        type2 = lq1Var;
                    }
                } else if (type2 instanceof ParameterizedType) {
                    type2 = (ParameterizedType) type2;
                    Type ownerType = type2.getOwnerType();
                    Type typeV4 = V(type, cls, ownerType, map);
                    boolean zEquals = Objects.equals(typeV4, ownerType);
                    Type[] actualTypeArguments = type2.getActualTypeArguments();
                    int length2 = actualTypeArguments.length;
                    Type[] typeArr = actualTypeArguments;
                    boolean z = false;
                    while (i < length2) {
                        Type typeV5 = V(type, cls, typeArr[i], map);
                        if (!Objects.equals(typeV5, typeArr[i])) {
                            if (!z) {
                    ...
                    if (!zEquals || z) {
                        lq1Var = new lq1(typeV4, (Class) type2.getRawType(), typeArr);
                        type2 = lq1Var;
                    }
                    ...
                    if (lowerBounds.length == 1) {
                        Type typeV6 = V(type, cls, lowerBounds[0], map);
                        if (typeV6 != lowerBounds[0]) {
                            type2 = new mq1(new Type[]{Object.class}, typeV6 instanceof WildcardType ? ((WildcardType) typeV6).getLowerBounds() : new Type[]{typeV6});
                        }
                    } else if (upperBounds.length == 1) {
                        Type typeV7 = V(type, cls, upperBounds[0], map);
                        if (typeV7 != upperBounds[0]) {
                            type2 = new mq1(typeV7 instanceof WildcardType ? ((WildcardType) typeV7).getUpperBounds() : new Type[]{typeV7}, b);
                        }
                    }
                }
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Bundle z(View view) {
        boolean zA;
        boolean z;
        view.getClass();
        Context context = view.getContext();
        context.getClass();
        boolean zC = n12.c((o04) je.F(context).a.e.getValue(), o04.b);
        boolean z2 = context instanceof Activity;
        boolean z3 = true;
        if (z2) {
            Activity activity = (Activity) context;
            z = activity.getWindow().getDecorView().getWidth() >= ContextUtilsKt.c(840.0f);
            if (context instanceof MainActivity) {
                ...
                h91 h91Var2 = h91.f;
                h91Var2.getClass();
                c31 c31Var = h91Var2.b;
                zA = c31Var != null ? ((b31) c31Var).a(activity) : false;
            }
        } else {
            zA = false;
            z = false;
        ...
        ActivityOptions activityOptionsMakeSceneTransitionAnimation = (!((context instanceof MainActivity) && zC && z3) && z2) ? ActivityOptions.makeSceneTransitionAnimation((Activity) context, view, "shared_element_end_root") : null;
        if (activityOptionsMakeSceneTransitionAnimation != null) {
            return activityOptionsMakeSceneTransitionAnimation.toBundle();
        }
        return null;
    }
}
