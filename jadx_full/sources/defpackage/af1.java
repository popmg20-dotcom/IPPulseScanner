    ...
    */
    public final HttpURLConnection c(URL url, String str) {
        ...
        try {
            ...
            qr1 qr1Var = (qr1) this.b.get();
            if (qr1Var != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) vo.e(((nl0) qr1Var).a()));
                } catch (InterruptedException e2) {
                    Thread.currentThread().interrupt();
                    a1.o("ContentValues", "Failed to get heartbeats header", e2);
                } catch (ExecutionException e3) {
                    a1.o("ContentValues", "Failed to get heartbeats header", e3);
                }
            }
            String string = null;
            try {
                PackageInfo packageInfoA = ay4.a(context).a(64, context.getPackageName());
                Signature[] signatureArr = packageInfoA.signatures;
                if (signatureArr == null || signatureArr.length != 1) {
                    bArrDigest = null;
                    if (bArrDigest != null) {
                        a1.d("ContentValues", "Could not get fingerprint hash for package: " + context.getPackageName());
                    } else {
                    ...
                    if (messageDigest != null) {
                        bArrDigest = messageDigest.digest(packageInfoA.signatures[0].toByteArray());
                    }
                    if (bArrDigest != null) {
                    }
                }
            } catch (PackageManager.NameNotFoundException e4) {
                a1.e("ContentValues", "No such package: " + context.getPackageName(), e4);
            }
