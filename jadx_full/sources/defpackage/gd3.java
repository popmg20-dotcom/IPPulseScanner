...
public final class gd3 extends m1 {
    ...
    */
    public static boolean o(ArrayList arrayList, boolean z) {
        for (int i = 0; i < 10; i++) {
            int[] iArr = p[i];
            ...
            if (z) {
                if (size == length) {
                    for (int i2 = 0; i2 < arrayList.size(); i2++) {
                        if (((k81) arrayList.get(i2)).c.a != iArr[i2]) {
                            break;
                        }
                    }
                    return true;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final k81 p(bn bnVar, ArrayList arrayList, int i) throws qs2 {
        int i2;
        int i3;
        int i4;
        int iF;
        ...
        while (true) {
            ...
            iArr3[3] = i7;
            int i11 = bnVar.f;
            int i12 = i9 >= 0 ? i9 : arrayList.isEmpty() ? i7 : ((k81) fw.r(arrayList, i8)).c.b[i8];
                ...
                if (bnVar.d(i12) != i15) {
                    ...
                    if (i17 == i10) {
                        ...
                        if (m1.h(iArr3)) {
                            ...
                            int i24 = i18;
                            System.arraycopy(iArr3, i19, iArr3, i4, iArr3.length - 1);
                            iArr3[i19] = i5;
                            try {
                                int[][] iArr5 = n;
                                int i25 = 0;
                                while (true) {
                                    if (i25 >= 6) {
                                    ...
                                    } else if (ov2.c(iArr3, iArr5[i25], 0.45f) < 0.2f) {
                                        if (!arrayList.isEmpty()) {
                                            int i26 = 0;
                                            while (i26 < 10) {
                                                int[] iArr6 = p[i26];
                                                    ...
                                                    while (size < iArr6.length) {
                                                        if (iArr6[size] == i25) {
                                                            ...
                                                            while (i27 < arrayList.size()) {
                                                                iArr2 = iArr4;
                                                                if (iArr6[(size - i27) - 1] == ((k81) arrayList.get((arrayList.size() - i27) - 1)).c.a) {
                                                                    i27++;
                                                                    iArr4 = iArr2;
                                                                }
                                                            }
                                        ...
                                        iArr = iArr4;
                                        if (!arrayList.isEmpty()) {
                                            int[] iArr7 = ((k81) fw.r(arrayList, 1)).c.b;
                                            int i28 = iArr7[0];
                                            float f = ((r4 - i28) / 15.0f) * 17.0f;
                                            float f2 = iArr7[1];
                                            float f3 = f * 2.0f;
                                            float f4 = (0.9f * f3) + f2;
                                            float f5 = (f3 * 1.1f) + f2;
                                        ...
                                        se1Var = new se1(i25, i24, iF, i, new int[]{i24, iF});
                                    } else {
                                        i25++;
                                    }
                                }
                            ...
                            if (se1Var == null) {
                                int i29 = iArr[0];
                                iE = bnVar.d(i29) ? bnVar.e(bnVar.f(i29)) : bnVar.f(bnVar.e(i29));
                            } else {
                                try {
                                    hi0VarM2 = m(bnVar, se1Var, z, true);
                                    z2 = false;
                                } catch (qs2 unused3) {
                                    int i30 = iArr[0];
                                    iE = bnVar.d(i30) ? bnVar.e(bnVar.f(i30)) : bnVar.f(bnVar.e(i30));
                                    i9 = iE;
                                }
                                if (z2) {
                                    if (!arrayList.isEmpty() && ((k81) fw.r(arrayList, 1)).b == null) {
                                        throw qs2.a();
                                    }
                                    try {
                                        hi0VarM = m(bnVar, se1Var, z, false);
                                    } catch (qs2 unused4) {
                                        hi0VarM = null;
                                    }
                                    return new k81(hi0VarM2, hi0VarM, se1Var);
                                }
                                i6 = i14;
                                i7 = 0;
                                i8 = 1;
                            ...
                            if (i13 != 0) {
                                ...
                                for (int i31 = 0; i31 < length2 / 2; i31++) {
                                    int i32 = iArr3[i31];
                                    int i33 = (length2 - i31) - 1;
                                    iArr3[i31] = iArr3[i33];
                                    iArr3[i33] = i32;
                                }
                            }
