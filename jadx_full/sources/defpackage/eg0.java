...
public class eg0 implements om1, t31, wy3, f91, mn1, on1 {
    ...
    */
    public static eg0 s(Context context) {
        FileChannel channel;
        ...
        try {
            ...
            try {
                return new eg0(0, channel, fileLockLock);
            } catch (IOException e2) {
                e = e2;
                a1.e("CrossProcessLock", "encountered error while creating and acquiring the lock, ignoring", e);
