...
public final class qf5 extends k95 {
    ...
    */
    public final int b1(String str, String str2, Object obj, Bundle bundle, List list, boolean z, boolean z2) {
        int i;
        int size;
        k85 k85Var = (k85) this.f;
        V0();
        ...
        if (!f2(obj)) {
            ...
            if (size > 200) {
                t65 t65Var = k85Var.Y;
                k85.h(t65Var);
                t65Var.E0.d("Parameter array is too long; discarded. Value kind, name, array length", "param", str2, Integer.valueOf(size));
                i = 17;
                if (z3) {
        ...
        if (!g2("param", str2, iMax, obj)) {
            if (!z2) {
                return 4;
            }
            if (obj instanceof Bundle) {
                h2(str, str2, (Bundle) obj, list, z);
                return i;
            }
            if (obj instanceof Parcelable[]) {
                ...
                while (i2 < length) {
                    ...
                    if (!(parcelable instanceof Bundle)) {
                        t65 t65Var2 = k85Var.Y;
                        k85.h(t65Var2);
                        t65Var2.E0.c("All Parcelable[] elements must be of type Bundle. Value type, name", parcelable.getClass(), str2);
                        return 4;
                    }
                    h2(str, str2, (Bundle) parcelable, list, z);
                    i2++;
                }
            } else {
                if (!(obj instanceof ArrayList)) {
                ...
                while (i2 < size2) {
                    ...
                    if (!(obj2 instanceof Bundle)) {
                        t65 t65Var3 = k85Var.Y;
                        k85.h(t65Var3);
                        t65Var3.E0.c("All ArrayList elements must be of type Bundle. Value type, name", obj2 != null ? obj2.getClass() : "null", str2);
                        return 4;
                    }
                    h2(str, str2, (Bundle) obj2, list, z);
                    i2++;
                }
            }
        }
    ...
    */
    public final long s1() {
        ...
        long j = Build.VERSION.SDK_INT < 30 ? 4L : SdkExtensions.getExtensionVersion(30) < 4 ? 8L : r1() < ((Integer) r55.m0.a(null)).intValue() ? 16L : 0L;
        if (!u1("android.permission.ACCESS_ADSERVICES_ATTRIBUTION")) {
            j |= 2;
        }
        if (j == 0) {
            if (this.A0 == null) {
                ...
                if (nj2VarQ1 != null) {
                    try {
                        num = (Integer) nj2VarQ1.b().get(10000L, TimeUnit.MILLISECONDS);
                        if (num != null) {
                            try {
                                if (num.intValue() == 1) {
                                    zBooleanValue = true;
                                ...
                                e = e2;
                                k85.h(t65Var);
                                t65Var.C0.b(e, "Measurement manager api exception");
                    ...
                    k85.h(t65Var);
                    t65Var.H0.b(num, "Measurement manager api status result");
                    zBooleanValue = this.A0.booleanValue();
                }
                if (!zBooleanValue) {
                    j = 64;
                }
