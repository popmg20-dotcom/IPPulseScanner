...
public class jl2 extends m0 implements Menu {
    public final nk2 c;

    public jl2(Context context, nk2 nk2Var) {
        super(context);
        if (nk2Var != null) {
            this.c = nk2Var;
        } else {
            xe.k("Wrapped Object can not be null.");
            throw null;
        }
    }
    ...
    public final MenuItem add(CharSequence charSequence) {
        return l(this.c.a(0, 0, 0, charSequence));
    }
    ...
    public final MenuItem findItem(int i) {
        return l(this.c.findItem(i));
    }

    @Override // android.view.Menu
    public final MenuItem getItem(int i) {
        return l(this.c.getItem(i));
    }
    ...
    public final void removeGroup(int i) {
        if (((xw3) this.b) != null) {
            ...
            while (true) {
                ...
                if (((b64) xw3Var.f(i2)).getGroupId() == i) {
                    ((xw3) this.b).g(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (((xw3) this.b) != null) {
            ...
            while (true) {
                ...
                if (((b64) xw3Var.f(i2)).getItemId() == i) {
                    ((xw3) this.b).g(i2);
                    break;
                }
                i2++;
    ...
    public final MenuItem add(int i) {
        return l(this.c.add(i));
    }

    @Override // android.view.Menu
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return l(this.c.a(i, i2, i3, charSequence));
    }

    @Override // android.view.Menu
    public final MenuItem add(int i, int i2, int i3, int i4) {
        return l(this.c.add(i, i2, i3, i4));
    }
}
