    ...
    */
    public final boolean m(int i, Rect rect) {
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            tz3Var.c(((Integer) arrayList.get(i3)).intValue(), k(((Integer) arrayList.get(i3)).intValue()));
        }
        int i4 = this.l;
        int i5 = Integer.MIN_VALUE;
        p2 p2Var2 = i4 == Integer.MIN_VALUE ? null : (p2) vf2.f(tz3Var, i4);
        d7 d7Var = p;
        k01 k01Var = q;
        Chip chip = this.i;
        int i6 = -1;
        if (i == 1 || i == 2) {
            ...
            for (int i8 = 0; i8 < i7; i8++) {
                arrayList2.add((p2) tz3Var.d(i8));
            }
            Collections.sort(arrayList2, new rh1(z, d7Var));
            if (i == 1) {
                i2 = 0;
                int size = arrayList2.size();
                if (p2Var2 != null) {
                    size = arrayList2.indexOf(p2Var2);
                }
                int i9 = size - 1;
                obj = i9 >= 0 ? arrayList2.get(i9) : null;
            } else {
                if (i != 2) {
                    xe.k("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD}.");
                    return false;
                }
                int size2 = arrayList2.size();
                int iLastIndexOf = (p2Var2 == null ? -1 : arrayList2.lastIndexOf(p2Var2)) + 1;
            ...
            if (i != 17 && i != 33 && i != 66 && i != 130) {
                xe.k("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD, FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.");
                return false;
            }
            Rect rect2 = new Rect();
            int i10 = this.l;
            if (i10 != Integer.MIN_VALUE) {
                ...
                if (i == 17) {
                    ...
                    if (i != 130) {
                        xe.k("direction must be one of {FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.");
                        return false;
                    }
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                p2 p2Var3 = (p2) tz3Var.d(i12);
                if (p2Var3 != p2Var2) {
                    d7Var.getClass();
                    p2Var3.f(rect4);
                    if (vo.z(i, rect2, rect4)) {
                        if (vo.z(i, rect2, rect3) && !vo.g(i, rect2, rect4, rect3)) {
                            if (!vo.g(i, rect2, rect3, rect4)) {
                                int iC = vo.C(i, rect2, rect4);
                                int iE = vo.E(i, rect2, rect4);
                                int i13 = (iE * iE) + (iC * 13 * iC);
                                int iC2 = vo.C(i, rect2, rect3);
                                int iE2 = vo.E(i, rect2, rect3);
                                if (i13 < (iE2 * iE2) + (iC2 * 13 * iC2)) {
                                    rect3.set(rect4);
                                    p2Var = p2Var3;
                                }
                            }
