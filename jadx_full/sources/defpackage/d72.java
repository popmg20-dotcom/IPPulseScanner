...
public final class d72 {
    public static final char[] a = v30.a(true);
    ...
    */
    public static char[] a(String str) {
        ...
        char[] cArrG = new char[Math.min(Math.max(16, Math.min((length >> 3) + 6, 1000) + length), 32000)];
        int[] iArr = v30.f;
        ...
        if (lb4Var == null) {
            return Arrays.copyOfRange(cArrG, 0, i3);
        }
        lb4Var.d = i3;
        try {
            return lb4Var.d();
