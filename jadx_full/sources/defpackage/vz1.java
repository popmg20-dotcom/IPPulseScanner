...
public final class vz1 {
    ...
    public vz1(TextInputLayout textInputLayout) {
        ...
        this.a = ek0.C(context, R.attr.motionDurationShort4, 217);
        this.b = ek0.C(context, R.attr.motionDurationMedium4, 167);
        this.c = ek0.C(context, R.attr.motionDurationShort4, 167);
        this.d = l72.W(context, R.attr.motionEasingEmphasizedDecelerateInterpolator, t8.d);
        LinearInterpolator linearInterpolator = t8.a;
        this.e = l72.W(context, R.attr.motionEasingEmphasizedDecelerateInterpolator, linearInterpolator);
        this.f = l72.W(context, R.attr.motionEasingLinearInterpolator, linearInterpolator);
    }
    ...
    public final void i(int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new uz1(this, i2, e(i), i, e(i2)));
            animatorSet.start();
        } else if (i != i2) {
