...
public final class yl3 extends Drawable {
    public float a;
    ...
    public yl3(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(zl3.a(this.e, this.a, this.g)), (int) Math.ceil(zl3.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
