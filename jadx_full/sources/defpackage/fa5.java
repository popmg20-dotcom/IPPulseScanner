...
public class fa5 implements oy1, h73, qv1 {
    ...
    */
    public it0 n(int i, String str) {
        it0 it0Var = (it0) ((HashMap) this.z).get(str);
        if (it0Var != null) {
            if (i == 3 || (i == 1 && ((it0Var instanceof ws0) || (it0Var instanceof zs0)))) {
                return it0Var;
            }
            if (i == 2) {
                if (!(it0Var instanceof ws0)) {
                    if (!(it0Var instanceof zs0)) {
                        if (!(it0Var instanceof ht0)) {
                        }
                    }
                }
        ...
        Iterator it = ((Set) this.f).iterator();
        while (it.hasNext()) {
            it0 it0Var2 = (it0) ((HashMap) ((gt0) it.next()).z0.z).get(str);
            if (it0Var2 != null) {
                if (i != 3) {
                    if (i == 1 && ((it0Var2 instanceof ws0) || (it0Var2 instanceof zs0))) {
                        return it0Var2;
                    }
                    if (i != 2 || (!(it0Var2 instanceof ws0) && !(it0Var2 instanceof zs0) && !(it0Var2 instanceof ht0) && !(it0Var2 instanceof lt0))) {
                    }
                }
                return it0Var2;
            }
