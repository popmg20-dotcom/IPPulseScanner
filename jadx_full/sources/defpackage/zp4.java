...
public final class zp4 {
    ...
    */
    public final boolean e(View view, float f, float f2) {
        if (view != null) {
            yr2 yr2Var = this.s;
            boolean z = yr2Var.F(view) > 0;
            boolean z2 = yr2Var.G() > 0;
            if (z && z2) {
                float f3 = (f2 * f2) + (f * f);
                int i = this.b;
                if (f3 > i * i) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked != 3) {
                if (actionMasked == 5) {
                    ...
                    } else if (i == 2 && (viewI = i((int) x2, (int) y3)) == this.t) {
                        u(viewI, pointerId2);
                    }
            ...
            for (int i2 = 0; i2 < pointerCount; i2++) {
                ...
                if ((this.k & (1 << pointerId3)) != 0) {
                    ...
                    View viewI3 = i((int) x3, (int) y4);
                    boolean zE = e(viewI3, f, f2);
                    if (zE) {
                        int left = viewI3.getLeft();
                        int iH = yr2Var.h(viewI3, ((int) f) + left);
                        int top = viewI3.getTop();
                        int i3 = yr2Var.i(viewI3, ((int) f2) + top);
                        int iF = yr2Var.F(viewI3);
                        int iG = yr2Var.G();
                        if ((iF == 0 || (iF > 0 && iH == left)) && (iG == 0 || (iG > 0 && i3 == top))) {
                            break;
                        }
                        n(f, f2, pointerId3);
                        if (this.a == 1 || (zE && u(viewI3, pointerId3))) {
                            break;
                        }
                    }
                }
