...
public final class rc {
    ...
    public static Method d(String str) {
        try {
            ...
            a1.o("ACTVAutoSizeHelper", "Failed to retrieve TextView#" + str + "() method", e);
            return null;
        }
    }
    ...
    public static Object e(String str, Object obj, Object obj2) {
        try {
            ...
            a1.o("ACTVAutoSizeHelper", "Failed to invoke TextView#" + str + "() method", e);
            return obj2;
        }
    }
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            xe.q("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout staticLayoutA = nc.a(charSequence, (Layout.Alignment) e("getLayoutAlignment", textView, Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
        ...
        if (fApplyDimension != textView.getPaint().getTextSize()) {
            ...
            if (textView.getLayout() != null) {
                ...
                try {
                    ...
                    a1.o("ACTVAutoSizeHelper", "Failed to invoke TextView#nullLayouts() method", e);
                }
                if (zIsInLayout) {
