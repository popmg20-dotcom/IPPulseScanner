...
public final class aw {
    ...
    public /* synthetic */ aw(float f, float f2, float f3, float f4, float f5, float f6) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public static aw a(int i) {
        xr4 xr4Var = xr4.k;
        float fQ = yr2.Q(Color.red(i));
        float fQ2 = yr2.Q(Color.green(i));
        float fQ3 = yr2.Q(Color.blue(i));
        float[][] fArr = yr2.d;
        float[] fArr2 = fArr[0];
        ...
        float fPow4 = ((float) Math.pow((f18 * xr4Var.b) / f9, xr4Var.j * f8)) * 100.0f;
        Math.sqrt(fPow4 / 100.0f);
        float f20 = f9 + 4.0f;
        float fPow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, xr4Var.f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((((double) (((double) fAtan2) < 20.14d ? 360.0f + fAtan2 : fAtan2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * xr4Var.e) * xr4Var.c) * ((float) Math.sqrt((f15 * f15) + (f14 * f14)))) / (f17 + 0.305f), 0.9d)) * ((float) Math.sqrt(((double) fPow4) / 100.0d));
        Math.sqrt((r0 * f8) / f20);
        float f21 = (1.7f * fPow4) / ((0.007f * fPow4) + 1.0f);
        float fLog = ((float) Math.log((f7 * fPow5 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f19;
        return new aw(fAtan2, fPow5, fPow4, f21, fLog * ((float) Math.cos(d2)), fLog * ((float) Math.sin(d2)));
    }

    public static aw b(float f, float f2, float f3) {
        xr4 xr4Var = xr4.k;
        float f4 = xr4Var.d;
        Math.sqrt(((double) f) / 100.0d);
        float f5 = xr4Var.a + 4.0f;
        float f6 = xr4Var.i * f2;
        Math.sqrt(((f2 / ((float) Math.sqrt(r1))) * xr4Var.d) / f5);
        float f7 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float fLog = ((float) Math.log((((double) f6) * 0.0228d) + 1.0d)) * 43.85965f;
        double d = (3.1415927f * f3) / 180.0f;
        return new aw(f3, f2, f, f7, fLog * ((float) Math.cos(d)), fLog * ((float) Math.sin(d)));
    }
    ...
    */
    public int c(xr4 xr4Var) {
        ...
        float fPow2 = xr4Var.a * ((float) Math.pow(((double) f2) / 100.0d, (1.0d / ((double) xr4Var.d)) / ((double) xr4Var.j)));
        float f5 = fCos * 3846.1538f * xr4Var.e * xr4Var.c;
        float f6 = fPow2 / xr4Var.b;
        ...
        float[] fArr5 = fArr2[2];
        return u70.a(f18, f19, (f17 * fArr5[2]) + (f16 * fArr5[1]) + (f15 * fArr5[0]));
    }
}
