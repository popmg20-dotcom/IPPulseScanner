    ...
    */
    public final void z(ps2 ps2Var) {
        ...
        while (true) {
            ...
            if (objectVolatile instanceof v3) {
                while (true) {
                    Unsafe unsafe3 = re.a;
                    z00 z00Var3 = this;
                    ps2 ps2Var3 = ps2Var;
                    z00Var = z00Var3;
                    ps2Var2 = ps2Var3;
                    if (unsafe3.compareAndSwapObject(z00Var3, y0, objectVolatile, ps2Var3)) {
                        return;
                    }
                    if (unsafe3.getObjectVolatile(z00Var, j) != objectVolatile) {
                        break;
                ...
                ps2Var2 = ps2Var;
                z00Var = this;
                if ((objectVolatile instanceof t00) || (objectVolatile instanceof sr3)) {
                    break;
                }
                if (objectVolatile instanceof r80) {
                    r80 r80Var = (r80) objectVolatile;
                    if (!unsafe2.compareAndSwapInt(r80Var, r80.b, 0, 1)) {
                        B(ps2Var2, objectVolatile);
                        throw null;
                    }
                    if (objectVolatile instanceof c10) {
                        Throwable th = r80Var.a;
                        if (ps2Var2 instanceof t00) {
                            z00Var.n((t00) ps2Var2, th);
                            return;
                        } else {
                            z00Var.p((sr3) ps2Var2, th);
                            return;
                        }
                    }
                    return;
                ...
                if (objectVolatile instanceof p80) {
                    ...
                    if (ps2Var2 instanceof sr3) {
                        return;
                    }
                    t00 t00Var = (t00) ps2Var2;
                    Throwable th2 = p80Var.e;
                    if (th2 != null) {
                        z00Var.n(t00Var, th2);
                        return;
                    }
                    p80 p80VarA = p80.a(p80Var, t00Var, null, 29);
                    do {
                        unsafe = re.a;
                        if (unsafe.compareAndSwapObject(z00Var, y0, objectVolatile, p80VarA)) {
                            return;
                        }
                    } while (unsafe.getObjectVolatile(z00Var, j) == objectVolatile);
                } else {
                    if (ps2Var2 instanceof sr3) {
                        return;
                    }
                    p80 p80Var2 = new p80(objectVolatile, (t00) ps2Var2, (em1) null, (Throwable) null, 28);
                    while (true) {
                        p80 p80Var3 = p80Var2;
                        Unsafe unsafe4 = re.a;
                        z00Var2 = z00Var;
                        boolean zCompareAndSwapObject = unsafe4.compareAndSwapObject(z00Var2, y0, objectVolatile, p80Var3);
                        p80Var2 = p80Var3;
                        if (zCompareAndSwapObject) {
                            return;
                        }
                        if (unsafe4.getObjectVolatile(z00Var2, j) != objectVolatile) {
                            break;
                        } else {
                            z00Var = z00Var2;
                        }
