...
public final class jv0 implements Closeable, Flushable {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final synchronized void g(ue1 ue1Var, boolean z) {
        gv0 gv0Var = (gv0) ue1Var.b;
        if (!n12.c(gv0Var.g, ue1Var)) {
            throw new IllegalStateException("Check failed.");
        }
        if (!z || gv0Var.f) {
            for (int i = 0; i < 2; i++) {
                this.G0.C((u03) gv0Var.d.get(i));
            }
        } else {
            for (int i2 = 0; i2 < 2; i2++) {
                if (((boolean[]) ue1Var.z)[i2] && !this.G0.F((u03) gv0Var.d.get(i2))) {
                    ue1Var.e(false);
                    return;
                }
            }
            for (int i3 = 0; i3 < 2; i3++) {
                u03 u03Var = (u03) gv0Var.d.get(i3);
                u03 u03Var2 = (u03) gv0Var.c.get(i3);
                boolean zF = this.G0.F(u03Var);
                iv0 iv0Var = this.G0;
                if (zF) {
                    u03Var2.getClass();
                    iv0Var.f.n(u03Var, u03Var2);
                } else {
                    u03 u03Var3 = (u03) gv0Var.c.get(i3);
                    if (!iv0Var.F(u03Var3)) {
                        j.a(iv0Var.U(u03Var3));
                    }
                }
                long j = gv0Var.b[i3];
                Long l = (Long) this.G0.M(u03Var2).e;
                long jLongValue = l != null ? l.longValue() : 0L;
                gv0Var.b[i3] = jLongValue;
                this.y0 = (this.y0 - j) + jLongValue;
            }
        }
        gv0Var.g = null;
        if (gv0Var.f) {
        ...
        if (z || gv0Var.e) {
            ...
            ge3Var.writeByte(32);
            ge3Var.S(gv0Var.a);
            for (long j2 : gv0Var.b) {
                ge3Var.writeByte(32);
                ge3Var.n(j2);
            }
            ge3Var.writeByte(10);
        } else {
            this.Y.remove(gv0Var.a);
            ge3Var.S("REMOVE");
            ge3Var.writeByte(32);
            ge3Var.S(gv0Var.a);
            ge3Var.writeByte(10);
