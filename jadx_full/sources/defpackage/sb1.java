...
public final class sb1 implements s61 {
    ...
    */
    public boolean d(long j, w75 w75Var) {
        ...
        if (((ArrayList) this.A).isEmpty() || ((((w75) ((ArrayList) this.A).get(0)).s() / 1000) / 60) / 60 == ((w75Var.s() / 1000) / 60) / 60) {
            long jI = this.b + ((long) w75Var.i());
            ff5 ff5Var = (ff5) this.X;
            if (!ff5Var.c0().f1(null, r55.e1)) {
                ff5Var.c0();
                if (jI < Math.max(0, ((Integer) r55.j.a(null)).intValue())) {
                }
            } else if (!((ArrayList) this.A).isEmpty()) {
                ff5Var.c0();
                if (jI < Math.max(0, ((Integer) r55.j.a(null)).intValue())) {
                    this.b = jI;
                    ((ArrayList) this.A).add(w75Var);
                    ((ArrayList) this.z).add(Long.valueOf(j));
                    int size = ((ArrayList) this.A).size();
                    ff5Var.c0();
                    if (size < Math.max(1, ((Integer) r55.k.a(null)).intValue())) {
                        return true;
                    }
                }
            }
