...
public final class me3 extends du1 implements q61 {
    ...
    */
    public final boolean h(a6 a6Var, List list) {
        ev1 ev1Var = a6Var.i;
        String str = ev1Var.d;
            ...
            if (a6Var2.a(a6Var)) {
                ...
                if (this.i != null && list != null && !list.isEmpty()) {
                    ...
                    while (true) {
                        ...
                        em3 em3Var2 = (em3) it.next();
                        Proxy.Type type = em3Var2.b.type();
                        Proxy.Type type2 = Proxy.Type.DIRECT;
                        if (type == type2 && em3Var.b.type() == type2 && n12.c(em3Var.c, em3Var2.c)) {
                            if (a6Var.d == ju2.a) {
                                TimeZone timeZone2 = jz4.a;
                                ev1 ev1Var2 = a6Var3.i;
                                if (ev1Var.e == ev1Var2.e) {
                                    boolean zC = n12.c(str, ev1Var2.d);
                                    zq1 zq1Var = this.f;
                                    if (!zC) {
                                        if (!this.k && zq1Var != null) {
                                            List listA = zq1Var.a();
                                            if (!listA.isEmpty()) {
                                                Object obj = listA.get(0);
                                                obj.getClass();
                                                if (ju2.b(str, (X509Certificate) obj)) {
                                                    try {
                                                        n20 n20Var = a6Var.e;
                                                        n20Var.getClass();
                                                        zq1Var.getClass();
                                                        List listA2 = zq1Var.a();
                                                        str.getClass();
                                                        listA2.getClass();
                                                        Iterator it2 = n20Var.a.iterator();
                                                        if (!it2.hasNext()) {
                                                            return true;
                                                        }
                                                        dw2.I(it2.next());
