...
echo "Updating LocalSocks5Server.java with robust proxy forwarding and host mapping..."
...
public class LocalSocks5Server {
    ...
    public LocalSocks5Server(Context context, int port, HashMap<String, String> hostsMap, String dns) {
        this.port = port;
    ...
    private void handleClient(Socket client) {
        try {
            ...
            // Send response: version 5, no auth (0x00)
            ...
            if (cmd == 0x01) { // CONNECT command
                ...
                // Unsupported command (e.g. UDP ASSOCIATE) - reply command not supported
...
git add .
git commit -m "Fix: Implement robust LocalSocks5Server connection handling and routing"
git push origin main

echo "Pushed LocalSocks5Server fix successfully!"
